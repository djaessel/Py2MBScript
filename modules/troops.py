...
player = Troop("player", "Player", faction="fac_player_faction", strength=4, agility=4, face_code_1="0x000000018000000136db6db6db6db6db00000000001db6db0000000000000000")
player.wp(15)
player.add_flag(TroopFlag.IS_HERO)
player.add_flag(TroopFlag.UNMOVEABLE_IN_PARTY_WINDOW)

multiplayer_profile_troop_male = Troop("multiplayer_profile_troop_male", "multiplayer_profile_troop_male", faction="fac_commoners", face_code_1="0x000000018000000136db6db6db6db6db00000000001db6db0000000000000000")
...
multiplayer_profile_troop_male = Troop("multiplayer_profile_troop_female", "multiplayer_profile_troop_female", faction="fac_commoners", face_code_1="0x000000018000000136db6db6db6db6db00000000001db6db0000000000000000")
multiplayer_profile_troop_male.wp(15)
multiplayer_profile_troop_male.add_flag(TroopFlag.IS_HERO)
multiplayer_profile_troop_male.add_flag(TroopFlag.IS_FEMALE)
multiplayer_profile_troop_male.add_flag(TroopFlag.GUARANTEE_ALL)

temp_troop = Troop("temp_troop", "Temp Troop", faction="fac_commoners", face_code_1="0x000000018000000136db6db6db6db6db00000000001db6db0000000000000000")
