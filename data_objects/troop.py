...
class Troop:
    ...
    def __init__(self, id, name, plural_name="", faction=fac.no_faction, strength=7, agility=5, intelligence=4, charisma=4, level=1, face_code_1="man_face_middle_1", face_code_2="", troop_image=""):
        self.id = id
        self.name = name
