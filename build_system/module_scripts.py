...
(try_end),
(scene_prop_get_slot,":item_situation",":instance_id",1), # slot_openclose
(try_begin),
...
(else_try),
    ...
    (assign,reg0,":val1"),
    (try_begin),
        (is_between,":val1",60,901), # mins, maxs
...
(try_begin),
    ...
    (else_try),
        ...
        (else_try),
            ...
            (prop_instance_get_position, pos0, ":instance_id"),
            (assign,":smallest_dist",-1),
            (try_for_range, ":entry_point_no", 100, 110), # usable_items_start, usable_items_end
            ...
            (try_begin),
                ...
                (scene_prop_set_slot,":effected_object_instance_id",2,0), # slotSmokeEffectDone
                (prop_instance_enable_physics, ":effected_object_instance_id", 0),
