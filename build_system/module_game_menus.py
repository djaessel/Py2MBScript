...
(else_try),
    ...
    (try_for_range, ":p_004", "p_town_1", "p_castle_1"),
        (store_distance_to_party_from_party,":distance_parties_005",":p_004","$g_encountered_party"),
        (try_begin),
...
(try_begin),
    ...
    (try_begin),
        ...
        (store_distance_to_party_from_party,":distance_parties_002",":party_slot_001","$g_enemy_party"),
        (try_begin),
...
(try_end),
(troop_clear_inventory,"trp_temp_troop"),
(party_get_slot,":party_slot_004","$current_town",120),
