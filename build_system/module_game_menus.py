...
(try_begin),
    ...
    (str_store_string,s1,":str_store_string("str_battle_won")"),
(else_try),
    (str_store_string,s1,":str_store_string("str_battle_lost")"),
(try_end),
(try_begin),
...
(try_begin),
    ...
    (str_store_string,s14,":str_store_string("str_woman")"),
    (val_add, ":var001", 1),
(else_try),
    (str_store_string,s14,":str_store_string("str_man")"),
(try_end),
(try_begin),
    (eq,":::background_type",1),
    (str_store_string,s15,":str_store_string("str_noble")"),
    (val_sub, ":var001", 1),
(else_try),
    (str_store_string,s15,":str_store_string("str_common")"),
(try_end),
(try_begin),
    (eq,":var001",-1),
    (str_store_string,s16,":str_store_string("str_may_find_that_you_are_able_to_take_your_place_among_calradias_great_lords_relatively_quickly")"),
(else_try),
    (eq,":var001",0),
    (str_store_string,s16,":str_store_string("str_may_face_some_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords")"),
(else_try),
    (eq,":var001",1),
    (str_store_string,s16,":str_store_string("str_may_face_great_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords")"),
(try_end),
],
[
]),
...
(try_begin),
    ...
    (assign,"$current_string_reg",10),
(try_end),
(str_store_string,s3,":str_store_string_reg(_current_string_reg)"),
(try_begin),
    (ge,":::current_string_reg",14),
    (str_store_string,s5,":str_store_string()"),
(else_try),
    (str_store_string,s5,":str_store_string()"),
(try_end),
],
...
(else_try),
    (str_store_string,s2,":str_store_string("str_space")"),
(try_end),
(assign,reg2,"$g_player_party_morale_modifier_leadership"),
(try_begin),
    (gt,reg2,0),
    (str_store_string,s3,":str_store_string("@{!} +")"),
(else_try),
    (str_store_string,s3,":str_store_string("str_space")"),
(try_end),
(try_begin),
    (gt,":::g_player_party_morale_modifier_no_food",0),
    (assign,reg7,"$g_player_party_morale_modifier_no_food"),
    (str_store_string,s5,":str_store_string("@^No food:  -{reg7}")"),
(else_try),
    (str_store_string,s5,":str_store_string("str_space")"),
(try_end),
(assign,reg3,"$g_player_party_morale_modifier_food"),
(try_begin),
    (gt,reg3,0),
    (str_store_string,s4,":str_store_string("@{!} +")"),
(else_try),
    (str_store_string,s4,":str_store_string("str_space")"),
(try_end),
(try_begin),
    (gt,":::g_player_party_morale_modifier_debt",0),
    (assign,reg6,"$g_player_party_morale_modifier_debt"),
    (str_store_string,s6,":str_store_string("@^Wage debt:  -{reg6}")"),
(else_try),
    (str_store_string,s6,":str_store_string("str_space")"),
(try_end),
(party_get_morale, reg5,"p_main_party"),
(store_sub, reg4, reg5, ":var001"),
(try_begin),
    (gt,reg4,0),
    (str_store_string,s7,":str_store_string("@{!} +")"),
(else_try),
    (str_store_string,s7,":str_store_string("str_space")"),
(try_end),
(assign,reg6,50),
(str_store_string,s1,":str_store_string("str_current_party_morale_is_reg5_current_party_morale_modifiers_are__base_morale__50_party_size_s2reg1_leadership_s3reg2_food_variety_s4reg3s5s6_recent_events_s7reg4_total__reg5___")"),
(try_for_range, ":fac_002", ":fac.kingdom_1", ":fac.kingdoms_end"),
    ...
    (str_store_string,s9,":str_store_faction_name(fac_002)"),
    (str_store_string,s1,":str_store_string("str_s1extra_morale_for_s9_troops__reg6_")"),
(try_end),
],
[
]),
("courtship_relations", 0, 
  "{s1}", 
  "none", [
(str_store_string,s1,":str_store_string("str_courtships_in_progress_")"),
(try_for_range, ":trp_001", ":trp.knight_1_1_wife", ":trp.heroes_end"),
    ...
    (gt,reg0,0),
    (assign,reg3,reg0),
    (str_store_string,s2,":str_store_troop_name(trp_001)"),
    ...
    (assign,reg4,":var004"),
    (str_store_string,s1,":str_store_string("str_s1_s2_relation_reg3_last_visit_reg4_days_ago")"),
(try_end),
(try_end),
(str_store_string,s1,":str_store_string("str_s1__poems_known")"),
(try_begin),
(gt,":::allegoric_poem_recitations",0),
(str_store_string,s1,":str_store_string("str_s1_storming_the_castle_of_love_allegoric")"),
(try_end),
(try_begin),
(gt,":::tragic_poem_recitations",0),
(str_store_string,s1,":str_store_string("str_s1_kais_and_layali_tragic")"),
(try_end),
(try_begin),
(gt,":::comic_poem_recitations",0),
(str_store_string,s1,":str_store_string("str_s1_a_conversation_in_the_garden_comic")"),
(try_end),
(try_begin),
(gt,":::heroic_poem_recitations",0),
(str_store_string,s1,":str_store_string("str_s1_helgered_and_kara_epic")"),
(try_end),
(try_begin),
(gt,":::mystic_poem_recitations",0),
(str_store_string,s1,":str_store_string("str_s1_a_hearts_desire_mystic")"),
(try_end),
],
[
]),
...
(try_end),
(gt,":troop_id_004",-1),
(str_store_string,s4,":str_store_troop_name_link(troop_id_004)"),
(assign,reg4,":var003"),
(str_store_string,s1,":str_store_string("@{!}{s1}^{s4}: {reg4}")"),
...
("companion_report", 0, 
  ...
  "none", [
(str_clear, 1),
(str_store_string,s7,":str_store_string("str_no_companions_in_service")"),
(try_begin),
    (eq,1,1),
    ...
    (try_begin),
        ...
        (try_begin),
            (eq,":troop_type_002",1),
            (str_store_string,s8,":str_store_string("str_husband")"),
        (else_try),
            (str_store_string,s8,":str_store_string("str_wife")"),
        (try_end),
    (try_end),
    (try_begin),
        (le,":troop_slot_001",0),
        (troop_get_slot,":troop_slot_001","trp_player",34),
        (str_store_string,s8,":str_store_string("str_betrothed")"),
    (try_end),
    (try_begin),
        (gt,":troop_slot_001",0),
        (str_store_string,s4,":str_store_troop_name(troop_slot_001)"),
        (troop_get_slot,":troop_slot_003",":troop_slot_001",12),
        (try_begin),
            (is_between,":troop_slot_003","p_town_1","p_salt_mine"),
            (str_store_string,s5,":str_store_party_name(troop_slot_003)"),
        (else_try),
            (troop_slot_eq,":troop_slot_001",2,2),
            (str_store_string,s5,":str_store_string("str_leading_party")"),
        (else_try),
            (str_store_string,s5,":str_store_string("str_whereabouts_unknown")"),
        (try_end),
    (try_end),
    (str_store_string,s3,":str_store_string("str_s4_s8_s5")"),
    (str_store_string,s2,":str_store_string(1)"),
    (str_store_string,s1,":str_store_string("str_s2_s3")"),
(try_end),
(try_begin),
    (ge,":::cheat_mode",1),
    (ge,":::npc_to_rejoin_party",0),
    (str_store_string,s5,":str_store_troop_name(_npc_to_rejoin_party)"),
    (str_store_string,s1,":str_store_string("@{!}DEBUG -- {s1}^NPC in rejoin queue: {s5}^")"),
(try_end),
(try_for_range, ":trp_004", ":trp.npc1", ":trp.kingdom_1_lord"),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (str_store_string,s4,":str_store_troop_name(trp_004)"),
            (try_begin),
        ...
        (else_try),
            ...
            (str_store_string,s11,":str_store_party_name(troop_slot_006)"),
        ...
        (else_try),
            ...
            (str_store_string,s9,":str_store_faction_name(troop_slot_007)"),
        ...
        (else_try),
            ...
            (str_store_string,s8,":str_store_string("str_attempting_to_rejoin_party")"),
            (str_store_string,s5,":str_store_string("str_whereabouts_unknown")"),
        (else_try),
            (troop_slot_ge,":trp_004",12,1),
            (str_store_string,s8,":str_store_string("str_separated_from_party")"),
            (str_store_string,s5,":str_store_string("str_whereabouts_unknown")"),
        (else_try),
            (try_begin),
                (check_quest_active,"qst_lend_companion"),
                (quest_slot_eq,"qst_lend_companion",2,":trp_004"),
                (str_store_string,s8,":str_store_string("@On loan,")"),
            (else_try),
            ...
            (try_begin),
                ...
                (assign, reg0, ":"@{!}DEBUG: {s4} current mission: {reg2}"),
                (assign, reg1, ":days on mission: {reg3}"),
                (assign, reg2, ":prisoner: {reg4}"),
                (assign, reg3, ":pphistory: {reg5}""),
                (display_message, "@{reg0} {reg1} {reg2} {reg3}"),
            (try_end),
        (try_end),
        (str_store_string,s3,":str_store_string("str_s4_s8_s5")"),
        (str_store_string,s2,":str_store_string(1)"),
    ...
    (else_try),
        ...
        (str_store_string,s4,":str_store_troop_name(trp_004)"),
        (str_store_string,s8,":str_store_string("str_missing_after_battle")"),
        (str_store_string,s5,":str_store_string("str_whereabouts_unknown")"),
        (str_store_string,s3,":str_store_string("str_s4_s8_s5")"),
        (str_store_string,s2,":str_store_string(1)"),
        (str_store_string,s1,":str_store_string("str_s2_s3")"),
...
(try_for_range, ":fac_002", ":fac.player_supporters_faction", ":fac.kingdoms_end"),
    ...
    (assign,":var006",reg0),
    (str_store_string,s26,":str_store_string(14)"),
    ...
    (str_store_string,s10,":str_store_faction_name(fac_002)"),
    (eq,1,1),
    (faction_get_slot,":faction_slot_011",":fac_002",64),
    (try_begin),
        (eq,":faction_slot_011",1),
        (str_store_string,s11,":str_store_string("@Appoint next marshal")"),
    (else_try),
        (is_between,":faction_slot_011","p_town_1","p_salt_mine"),
        (str_store_string,s12,":str_store_party_name(faction_slot_011)"),
        (str_store_string,s11,":str_store_string("@Award {s12} as fief")"),
    (else_try),
        (eq,":faction_slot_011",0),
        (str_store_string,s11,":str_store_string("@None")"),
    (else_try),
        (assign,reg3,":faction_slot_011"),
        (str_store_string,s11,":str_store_string("@{!}Error ({reg3})")"),
    (try_end),
    (store_current_hours,reg4),
    (faction_get_slot,":faction_slot_012",":fac_002",65),
    (val_sub, reg4, ":faction_slot_012"),
    (str_store_string,s10,":str_store_string("@{!}{s10}^Faction political issue: {s11}")"),
    (try_begin),
        (faction_slot_ge,":fac_002",64,1),
        (str_store_string,s10,":str_store_string("@{!}{s10} (on agenda {reg4} hours)")"),
    (try_end),
(try_end),
(assign,reg2,":faction_slot_010"),
(try_begin),
    (eq,":faction_slot_007",0),
    (str_store_string,s11,":str_store_string("@{!}Defending")"),
(else_try),
    (eq,":faction_slot_007",1),
    (str_store_string,s11,":str_store_string("@{!}Gathering army")"),
(else_try),
    (eq,":faction_slot_007",2),
    (str_store_string,s11,":str_store_party_name(faction_slot_008)"),
    (str_store_string,s11,":str_store_string("@{!}Besieging {s11}")"),
(else_try),
    (eq,":faction_slot_007",3),
    (str_store_string,s11,":str_store_party_name(faction_slot_008)"),
    (str_store_string,s11,":str_store_string("@{!}Raiding {s11}")"),
(else_try),
    (eq,":faction_slot_007",4),
    (str_store_string,s11,":str_store_party_name(faction_slot_008)"),
    (str_store_string,s11,":str_store_string("str_attacking_enemy_army_near_s11")"),
(else_try),
    (eq,":faction_slot_007",6),
    (str_store_string,s11,":str_store_party_name(faction_slot_008)"),
    (str_store_string,s11,":str_store_string("str_holding_feast_at_s11")"),
(else_try),
    (eq,":faction_slot_007",5),
    (str_store_string,s11,":str_store_party_name(faction_slot_008)"),
    (str_store_string,s11,":str_store_string("@{!}Attacking enemies around {s11}")"),
(else_try),
    (assign,reg4,":faction_slot_007"),
    (str_store_string,s11,":str_store_string("str_sfai_reg4")"),
(try_end),
(try_begin),
    (lt,":faction_slot_009",0),
    (str_store_string,s12,":str_store_string("@No one")"),
(else_try),
    (str_store_string,s12,":str_store_troop_name(faction_slot_009)"),
    (troop_get_slot,reg21,":faction_slot_009",150),
    (str_store_string,s12,":str_store_string("@{!}{s12} (controversy: {reg21})")"),
(try_end),
(try_for_parties, ":cur_party"),
    (party_slot_eq,":cur_party",4,12),
    (store_faction_of_party, ":party_faction_014", ":cur_party"),
    (eq,":party_faction_014",":fac_002"),
    (str_store_string,s38,":str_store_party_name(cur_party)"),
    (str_store_string,s12,":str_store_string("@{!}{s12}^Screening party: {s38}")"),
(try_end),
(try_end),
...
(assign,reg9,":var025"),
(assign,reg10,":var027"),
(str_store_string,s14,":str_store_string(26)"),
...
(try_end),
(str_store_string,s10,":str_store_faction_name(_g_cheat_selected_faction)"),
(str_store_string,s9,":str_store_string("@Selected faction is: {s10}^^{s9}")"),
],
[
]),
("character_report", 0, 
...
(try_begin),
    ...
    (str_store_string,s8,":str_store_item_name(_g_player_reading_book)"),
    (str_store_string,s9,":str_store_string()"),
(else_try),
...
(assign,":var001",0),
(assign,":var002",0),
(str_store_string,s6,":str_store_string("@none")"),
(str_store_string,s8,":str_store_string("@none")"),
(try_for_range, ":trp_003", ":trp.npc1", ":trp.knight_1_1_wife"),
    ...
    (try_begin),
        ...
        (try_begin),
            (eq,":var001",0),
            (str_store_string,s8,":str_store_troop_name(trp_003)"),
        (else_try),
            (eq,":var001",1),
            (str_store_string,s7,":str_store_troop_name(trp_003)"),
...
(else_try),
    ...
    (try_begin),
        (eq,":var002",0),
        (str_store_string,s6,":str_store_troop_name(trp_003)"),
    (else_try),
        (eq,":var002",1),
        (str_store_string,s5,":str_store_troop_name(trp_003)"),
        (str_store_string,s6,":str_store_string("@{s5} and {s6}")"),
    (else_try),
        (str_store_string,s5,":str_store_troop_name(trp_003)"),
        (str_store_string,s6,":str_store_string("@{!}{s5}, {s6}")"),
    (try_end),
    (val_add, ":var002", 1),
(try_end),
(str_clear, 12),
(try_begin),
    ...
    (str_store_string,s12,":str_store_string("str__right_to_rule_reg12")"),
(try_end),
(str_clear, 15),
(try_begin),
    ...
    (str_store_string,s15,":str_store_string("str_political_arguments_made_legality_reg3_rights_of_lords_reg4_unificationpeace_reg5_rights_of_commons_reg6_fief_pledges_reg7")"),
(try_end),
(assign,reg3,"$player_honor"),
(troop_get_slot,reg2,"trp_player",7),
(str_store_string,s9,":str_store_string("str_renown_reg2_honour_rating_reg3s12_friends_s8_enemies_s6_s9")"),
...
(try_begin),
    ...
    (try_for_range, ":var006", 0, ":var005"),
        ...
        (try_begin),
            (eq,":var006",0),
            (str_store_string,s8,":str_store_party_name(var007)"),
        (else_try),
            (eq,":var006",1),
            (str_store_string,s7,":str_store_party_name(var007)"),
            (str_store_string,s8,":str_store_string("@{s7} and {s8}")"),
        (else_try),
            (str_store_string,s7,":str_store_party_name(var007)"),
            (str_store_string,s8,":str_store_string("@{!}{s7}, {s8}")"),
...
(try_begin),
    ...
    (str_store_string,s8,":str_store_faction_name(_players_kingdom)"),
    (try_begin),
        ...
        (str_store_string,s9,":str_store_string("str_you_are_a_lord_lady_of_s8_s9")"),
    (else_try),
        (str_store_string,s9,":str_store_string("str_you_are_king_queen_of_s8_s9")"),
    (try_end),
(try_end),
],
[
...
(try_for_range, ":fac_001", ":fac.player_supporters_faction", ":fac.kingdoms_end"),
    ...
    (try_begin),
        ...
        (str_store_string,s3,":str_store_string("@Loyal")"),
    (else_try),
        (ge,":faction_relation_002",80),
        (str_store_string,s3,":str_store_string("@Devoted")"),
    (else_try),
        (ge,":faction_relation_002",70),
        (str_store_string,s3,":str_store_string("@Fond")"),
    (else_try),
        (ge,":faction_relation_002",60),
        (str_store_string,s3,":str_store_string("@Gracious")"),
    (else_try),
        (ge,":faction_relation_002",50),
        (str_store_string,s3,":str_store_string("@Friendly")"),
    (else_try),
        (ge,":faction_relation_002",40),
        (str_store_string,s3,":str_store_string("@Supportive")"),
    (else_try),
        (ge,":faction_relation_002",30),
        (str_store_string,s3,":str_store_string("@Favorable")"),
    (else_try),
        (ge,":faction_relation_002",20),
        (str_store_string,s3,":str_store_string("@Cooperative")"),
    (else_try),
        (ge,":faction_relation_002",10),
        (str_store_string,s3,":str_store_string("@Accepting")"),
    (else_try),
        (ge,":faction_relation_002",0),
        (str_store_string,s3,":str_store_string("@Indifferent")"),
    (else_try),
        (ge,":faction_relation_002",-10),
        (str_store_string,s3,":str_store_string("@Suspicious")"),
    (else_try),
        (ge,":faction_relation_002",-20),
        (str_store_string,s3,":str_store_string("@Grumbling")"),
    (else_try),
        (ge,":faction_relation_002",-30),
        (str_store_string,s3,":str_store_string("@Hostile")"),
    (else_try),
        (ge,":faction_relation_002",-40),
        (str_store_string,s3,":str_store_string("@Resentful")"),
    (else_try),
        (ge,":faction_relation_002",-50),
        (str_store_string,s3,":str_store_string("@Angry")"),
    (else_try),
        (ge,":faction_relation_002",-60),
        (str_store_string,s3,":str_store_string("@Hateful")"),
    (else_try),
        (ge,":faction_relation_002",-70),
        (str_store_string,s3,":str_store_string("@Revengeful")"),
    (else_try),
        (str_store_string,s3,":str_store_string("@Vengeful")"),
    (try_end),
    (str_store_string,s4,":str_store_faction_name(fac_001)"),
    (assign,reg1,":faction_relation_002"),
    (str_store_string,s2,":str_store_string("@{!}{s2}^{s4}: {reg1} ({s3})")"),
(try_end),
(str_store_string,s1,":str_store_string("@Your relation with the factions are:^{s2}")"),
],
[
]),
("camp", 4096, 
...
(try_for_range, ":var003", 0, ":party_num_prisoners_stacks_002"),
    (party_get_prisoner_stack_troop,":party_prisoner_troop_id_004","p_main_party",":var003"),
    (try_begin),
...
(else_try),
        ...
        (try_for_range, ":var003", 0, ":party_num_prisoners_stacks_002"),
            ...
            (try_begin),
                ...
                (try_begin),
                    ...
                    (party_get_prisoner_stack_size, "$g_prisoner_recruit_size","p_main_party",":var003"),
                (try_end),
            (try_end),
        (try_end),
    (try_end),
    (try_begin),
        ...
        (try_begin),
            ...
            (try_end),
        (try_end),
        (str_store_string,s1,":str_store_troop_name_by_count(_g_prisoner_recruit_troop_id,_g_prisoner_recruit_size)"),
        (str_store_string,s18,":str_store_string()"),
    (else_try),
        (str_store_string,s18,":str_store_string()"),
    (try_end),
(try_end),
...
(str_store_string,s2,":str_store_item_name(item_id_001)"),
(try_begin),
    (eq,1,1),
    ...
    (else_try),
        (str_store_string,s1,":str_store_string("@You flip through the pages of {s2},it soon gives you a headache)"),
    (try_end),
(try_end),
],
[
...
(try_begin),
    ...
    (change_screen_return),
(try_end),
(str_store_string,s10,":str_store_troop_name(_g_duel_troop)"),
(try_begin),
    (quest_slot_eq,"qst_duel_for_lady",2,"$g_duel_troop"),
    (check_quest_failed,"qst_duel_for_lady"),
    (str_store_string,s11,":str_store_string("str_you_lie_stunned_for_several_minutes_then_stagger_to_your_feet_to_find_your_s10_standing_over_you_you_have_lost_the_duel")"),
(else_try),
    (quest_slot_eq,"qst_duel_for_lady",2,"$g_duel_troop"),
    (check_quest_succeeded,"qst_duel_for_lady"),
    (str_store_string,s11,":str_store_string("str_s10_lies_in_the_arenas_dust_for_several_minutes_then_staggers_to_his_feet_you_have_won_the_duel")"),
(else_try),
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s1,":str_store_string("@Villagers")"),
...
(try_begin),
    ...
    (str_store_string,s1,":str_store_party_name(_g_encountered_party)"),
    (try_begin),
        (eq,":::g_encounter_type",0),
        (str_store_string,s2,":str_store_string()"),
    (else_try),
        (eq,":::g_encounter_type",1),
        (str_store_string,s3,":str_store_party_name(_g_encounter_is_in_village)"),
        (str_store_string,s2,":str_store_string()"),
    (else_try),
...
(else_try),
    (assign,1,0), # reg3
    (str_store_string,s3,":str_store_troop_name(var002)"),
(try_end),
],
[
]),
...
(inflict_casualties_to_party, "p_main_party", ":var002", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s8,":str_store_string_reg(0)"),
(try_begin),
    (ge,":::g_ally_party",0),
    (inflict_casualties_to_party, "$g_ally_party", ":var002", "p_temp_casualties"),
    (str_store_string,s8,":str_store_string_reg(0)"),
(try_end),
(inflict_casualties_to_party, "$g_encountered_party", ":var003", "p_temp_casualties"),
...
(try_end),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s9,":str_store_string_reg(0)"),
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s4,":str_store_string("str_order_attack_failure")"),
    (else_try),
        (call_script, "script_party_count_members_with_full_health", "p_collective_enemy"),
        (assign,":var013",reg0),
        (try_begin),
    ...
    (try_begin),
        ...
        (assign,"$no_soldiers_left",1),
        (str_store_string,s4,":str_store_string("str_order_attack_success")"),
    (else_try),
        (str_store_string,s4,":str_store_string("str_order_attack_continue")"),
    (try_end),
(try_end),
],
[
...
(str_store_string,s11,":str_store_string("@You were victorious!")"),
(try_begin),
...
(str_store_string,s11,":str_store_string()"),
...
(str_store_string,s10,":str_store_string("@^^Ally Casualties:{s0}")"),
(try_end),
],
[
]),
...
(else_try),
    ...
    (else_try),
        ...
        (try_begin),
            ...
            (str_store_string,s1,":str_store_troop_name(troop_id_006)"),
            (str_store_string,s3,":str_store_faction_name(troop_faction_020)"),
            (str_store_string,s17,":str_store_string()"),
    ...
    (else_try),
        ...
        (try_for_range, ":stack_no_018", ":::last_freed_hero", ":party_num_prisoners_stacks_025"),
            (eq,":var001",0),
            (party_get_prisoner_stack_troop,":troop_id_006","p_collective_enemy",":stack_no_018"),
            (try_begin),
                (troop_is_hero,":troop_id_006"),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (else_try),
                (eq,":::cheat_mode",1),
                (assign, reg0, ":and the player provided less than 40 percent of allied strength""),
                (display_message, "@{reg0}"),
            (try_end),
        (try_end),
    ...
    (else_try),
        (try_begin),
            ...
            (call_script, "script_add_log_entry", 10, "trp_player", "$g_encountered_party", -1, "$g_encountered_party"_faction),
...
(try_for_range, ":stack_no_002", 0, ":party_num_prisoners_stacks_001"),
    (party_get_prisoner_stack_troop,":party_prisoner_troop_id_003","p_main_party",":stack_no_002"),
    (try_begin),
...
(try_for_range, ":var002", 0, ":var001"),
    ...
    (try_begin),
        ...
        (else_try),
            ...
            (str_store_string,s0,":str_store_string()"),
        (else_try),
            (str_store_string,s0,":str_store_string("@You have trouble thinking straight after the battle,perhaps from a particularly hard hit to your head)"),
        (try_end),
    (else_try),
        (lt,":var001",200),
        (val_add, ":var001", 1),
...
("pre_join", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_party_name(_g_encountered_party)"),
(str_store_string,s2,":str_store_party_name(_g_encountered_party_2)"),
],
[
]),
("join_battle", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_party_name(_g_enemy_party)"),
(str_store_string,s2,":str_store_party_name(_g_ally_party)"),
(call_script, "script_encounter_calculate_fit"),
(try_begin),
    (eq,":::new_encounter",1),
    (assign,"$new_encounter",0),
...
(inflict_casualties_to_party, "p_main_party", ":var004", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s8,":str_store_string_reg(0)"),
(inflict_casualties_to_party, "$g_enemy_party", ":var002", "p_temp_casualties"),
...
(inflict_casualties_to_party, "$g_ally_party", ":var003", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s9,":str_store_string_reg(0)"),
...
(try_begin),
    ...
    (try_begin),
        ...
        (assign,"$no_soldiers_left",1),
        (str_store_string,s4,":str_store_string("str_join_order_attack_failure")"),
    (else_try),
        (call_script, "script_party_count_members_with_full_health", "p_collective_enemy"),
        (assign,":var011",reg0),
        (try_begin),
            ...
            (assign,"$g_battle_result",1),
            (assign,"$no_soldiers_left",1),
            (str_store_string,s4,":str_store_string("str_join_order_attack_success")"),
        (else_try),
            (str_store_string,s4,":str_store_string("str_join_order_attack_continue")"),
        (try_end),
    (try_end),
(try_end),
],
...
(assign,"$g_enemy_party","$g_encountered_party"),
(assign,"$g_ally_party",-1),
(str_store_string,s2,":str_store_party_name(_g_encountered_party)"),
(call_script, "script_encounter_calculate_fit"),
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s4,":str_store_string("str_sneaking_to_town_impossible")"),
    (else_try),
        (str_store_string,s4,":str_store_string("str_entrance_to_town_forbidden")"),
    (try_end),
(try_end),
(party_get_slot,":party_slot_001","$current_town",7),
(store_faction_of_party, ":party_faction_002", "$current_town"),
(str_store_string,s9,":str_store_faction_name(party_faction_002)"),
(try_begin),
    (ge,":party_slot_001",0),
    (str_store_string,s8,":str_store_troop_name(party_slot_001)"),
    (str_store_string,s7,":str_store_string("@{s8} of {s9}")"),
(try_end),
(try_begin),
    ...
    (else_try),
        ...
        (str_store_string,s11,":str_store_string("str__this_castle_is_temporarily_under_royal_control")"),
    (else_try),
        (str_store_string,s11,":str_store_string("str__this_castle_does_not_seem_to_be_under_anyones_control")"),
    (try_end),
(else_try),
    (try_begin),
        (eq,":party_slot_001","trp_player"),
    ...
    (else_try),
        (is_between,":party_faction_002","fac_player_supporters_faction","fac_kingdoms_end"),
        (str_store_string,s11,":str_store_string("str__this_town_is_temporarily_under_royal_control")"),
    (else_try),
        (str_store_string,s11,":str_store_string("str__the_townspeople_seem_to_have_declared_their_independence")"),
    (try_end),
(try_end),
...
(try_begin),
    ...
    (str_store_string,s3,":str_store_string("str_castle_is_abondened")"),
(else_try),
    (eq,":::g_encountered_party_faction","fac_player_supporters_faction"),
    (str_store_string,s3,":str_store_string("str_place_is_occupied_by_player")"),
(else_try),
    (lt,":::g_encountered_party_relation",0),
    (str_store_string,s3,":str_store_string("str_place_is_occupied_by_enemy")"),
(else_try),
(try_end),
(try_begin),
...
("castle_meeting_selected", 0, 
  ...
  "none", [
(str_store_string,s6,":str_store_troop_name(_castle_meeting_selected_troop)"),
],
[
]),
("castle_besiege", 4096, 
...
(else_try),
    (str_store_string,s2,":str_store_string()"),
(try_end),
(str_store_string,s3,":str_store_string("str_empty_string")"),
(try_begin),
    (ge,":::g_siege_method",1),
    (store_current_hours,":cur_hours_002"),
    (try_begin),
        ...
        (try_begin),
            (eq,":::g_siege_method",1),
            (str_store_string,s3,":str_store_string("@You're preparing to attack the walls)"),
        (else_try),
            (eq,":::g_siege_method",2),
            (str_store_string,s3,":str_store_string()"),
        (try_end),
...
(call_script, "script_encounter_calculate_fit"),
(str_store_string,s1,":str_store_string("@As a last defensive effort)"),
(str_store_string,s1,":str_store_string()"),
(try_begin),
...
(else_try),
    ...
    (try_begin),
        ...
        (else_try),
            ...
            (eq,":var002",1),
            (str_store_string,s1,":str_store_string("@You've breached the town walls)"),
        (else_try),
            (eq,":::g_siege_battle_state",2),
            (eq,":var002",1),
            (str_store_string,s1,":str_store_string("@The town centre is yours)"),
        (else_try),
            (jump_to_menu,"$g_siege_final_menu"),
        (try_end),
    (else_try),
...
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s8,":str_store_string_reg(0)"),
(inflict_casualties_to_party, "$g_encountered_party", ":var001", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s9,":str_store_string_reg(0)"),
(assign,"$no_soldiers_left",0),
(try_begin),
    ...
    (try_begin),
        (le,reg0,0),
        (assign,"$no_soldiers_left",1),
        (str_store_string,s4,":str_store_string("str_attack_walls_failure")"),
    (else_try),
        ...
        (try_begin),
            ...
            (assign,"$no_soldiers_left",1),
            (assign,"$g_battle_result",1),
            (str_store_string,s4,":str_store_string("str_attack_walls_success")"),
        (else_try),
            (str_store_string,s4,":str_store_string("str_attack_walls_continue")"),
        (try_end),
    (try_end),
(try_end),
],
...
(try_begin),
    ...
    (call_script, "script_faction_inflict_war_damage_on_faction", ":troop_faction_002", "$g_encountered_party_faction", 40), # var003
(try_end),
...
(try_begin),
    (is_between,"$g_encountered_party","p_town_1","p_castle_1"),
(try_end),
(call_script, "script_faction_inflict_war_damage_on_faction", "$players_kingdom", "$g_encountered_party_faction", 40), # var003
(try_begin),
...
(else_try),
    ...
    (str_store_string,s3,":str_store_party_name(_g_encountered_party)"),
    (try_begin),
...
(str_store_string,s9,":str_store_troop_name(faction_slot_001)"),
(try_begin),
    ...
    (try_begin),
        ...
        (assign,0,1), # reg8
    (try_end),
    (str_store_string,s5,":str_store_string("@However,since you are not a sworn {man/follower} of {s9})"),
(try_end),
],
[
]),
...
(faction_get_slot,":faction_slot_001","$players_kingdom",11),
(str_store_string,s3,":str_store_troop_name(faction_slot_001)"),
(str_store_string,s2,":str_store_party_name(_g_center_to_give_to_player)"),
(try_begin),
...
(str_store_string,s11,":str_store_troop_name(troop_slot_003)"),
(str_store_string,s7,":str_store_string("str_to_your_husband_s11")"),
],
[
]),
...
(str_store_string,s5,":str_store_troop_name(party_slot_002)"),
(assign,reg6,900),
...
(str_store_string,s1,":str_store_troop_name(faction_slot_002)"),
(str_store_string,s2,":str_store_party_name(_g_center_to_give_to_player)"),
],
[
]),
...
(try_begin),
    ...
    (try_for_range, ":p_001", ":p.village_1", ":p.salt_mine"),
        ...
        (str_store_string,s4,":str_store_party_name(p_001)"),
        (assign,0,1), # reg3
    (try_end),
(try_end),
],
...
("oath_fulfilled", 0, 
  ...
  "none", [
(faction_get_slot,":faction_slot_001","$players_kingdom",11),
(str_store_string,s1,":str_store_troop_name(faction_slot_001)"),
],
[
]),
...
(inflict_casualties_to_party, "p_main_party", ":var005", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s8,":str_store_string_reg(0)"),
(inflict_casualties_to_party, "$g_ally_party", ":var003", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
...
(inflict_casualties_to_party, "$g_enemy_party", ":var004", "p_temp_casualties"),
(call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
(str_store_string,s10,":str_store_string_reg(0)"),
(party_collect_attachments_to_party, "$g_enemy_party", "p_collective_enemy"),
(try_begin),
    ...
    (try_begin),
        (le,reg0,0),
        (str_store_string,s4,":str_store_string("str_siege_defender_order_attack_failure")"),
    (else_try),
        (call_script, "script_party_count_members_with_full_health", "p_collective_enemy"),
        (try_begin),
            (le,reg0,0),
            (assign,"$g_battle_result",1),
            (str_store_string,s4,":str_store_string("str_siege_defender_order_attack_success")"),
        (else_try),
            (str_store_string,s4,":str_store_string("str_siege_defender_order_attack_continue")"),
        (try_end),
    (try_end),
(try_end),
],
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s10,":str_store_string("@As you approach,you are spotted by the castle guards)"),
    (else_try),
        (str_store_string,s10,":str_store_string("@As you approach,you are spotted by the castle guards)"),
    (try_end),
(try_end),
(str_store_string,s2,":str_store_party_name(_current_town)"),
],
[
]),
("village", 256, 
...
(try_begin),
    ...
    (str_store_string,s60,":str_store_string(2)"),
    ...
    (str_store_string,s10,":str_store_string(var004)"),
    ...
    (try_end),
    (str_store_string,s12,":str_store_string(var004)"),
(try_end),
(str_clear, 11),
(try_begin),
...
(try_begin),
    ...
    (str_store_string,s7,":str_store_string("@{!} {s3} ({reg9}).")"),
(try_end),
(str_clear, 6),
(try_begin),
    ...
    (str_store_string,s35,":str_store_troop_name_by_count(party_slot_006,_qst_eliminate_bandits_infesting_village_num_bandits)"),
    (str_store_string,s6,":str_store_string()"),
...
(else_try),
    ...
    (str_store_string,s3,":str_store_troop_name_by_count(party_slot_001,party_slot_002)"),
    (try_begin),
        (eq,reg5,1),
        (str_store_string,s18,":str_store_string()"),
    (else_try),
...
(else_try),
    (str_store_string,s9,":str_store_string("@Try as you might,they raze the village to the ground to punish the peasants)"),
    (set_background_mesh, "mesh_pic_looted_village"),
(try_end),
],
[
...
(try_begin),
    ...
    (assign,":var002",130),
    (assign,":var003",135),
    (str_store_string,s17,":str_store_string("@village")"),
(else_try),
    (try_begin),
        (party_slot_eq,"$g_encountered_party",0,3),
        (str_store_string,s17,":str_store_string("@town")"),
    (else_try),
        (str_store_string,s17,":str_store_string("@castle")"),
    (try_end),
(try_end),
(try_for_range, ":var004", 134, 136), # var002, var003
    (party_slot_ge,"$g_encountered_party",":var004",1),
    (val_add, ":var001", 1),
    (call_script, "script_get_improvement_details", ":var004"),
    (try_begin),
        (eq,":var001",1),
        (str_store_string,s18,":str_store_string("@{!}{s0}")"),
    (else_try),
        (str_store_string,s18,":str_store_string("@{!}{s18}, {s0}")"),
    (try_end),
(try_end),
(try_begin),
    (eq,":var001",0),
    (str_store_string,s19,":str_store_string()"),
(else_try),
    (str_store_string,s19,":str_store_string()"),
(try_end),
(try_begin),
    ...
    (str_store_string,s7,":str_store_string(0)"),
    (assign,0,1), # reg6
...
(assign,":var001",reg0),
(str_store_string,s4,":str_store_string(0)"),
(str_store_string,s19,":str_store_string(1)"),
(call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
(assign,":var002",reg0),
(assign,":var003",reg1),
(assign,reg2,":var002"),
...
(else_try),
    (assign,1,0), # reg3
    (str_store_string,s3,":str_store_troop_name(var003)"),
(try_end),
],
[
]),
...
(try_begin),
    ...
    (str_store_string,s5,":str_store_string("@Luckily some of your companions come to search for you when you do not return)"),
(else_try),
    (str_store_string,s5,":str_store_string("@Luckily some passing townspeople find you lying by the side of the road)"),
(try_end),
],
[
]),
...
(else_try),
    (assign,1,0), # reg3
    (str_store_string,s1,":str_store_troop_name(var001)"),
(try_end),
...
(else_try),
    ...
    (try_begin),
        ...
        (call_script, "script_add_log_entry", 66, "trp_player", "$current_town", ":party_slot_003", "$g_encountered_party_faction"),
    (try_end),
...
(str_store_string,s9,":str_store_faction_name(party_faction_011)"),
(try_begin),
    (ge,":party_slot_010",0),
    (str_store_string,s8,":str_store_troop_name(party_slot_010)"),
    (str_store_string,s7,":str_store_string("@{s8} of {s9}")"),
(try_end),
(try_begin),
    ...
    (str_store_string,s10,":str_store_string(var013)"),
    (store_div, ":var___x1", ":party_slot_012", 20),
    (assign,":var013",":var___x1"),
    (val_min,":var013",4),
    (assign,":var013 +","str_town_alt_prosperity_0"),
    (str_store_string,s14,":str_store_string(var013)"),
(else_try),
    (str_clear, 14),
    (str_store_string,s10,":str_store_string()"),
(try_end),
(try_begin),
    (party_slot_eq,"$current_town",0,2),
    (try_begin),
    ...
    (else_try),
        ...
        (str_store_string,s11,":str_store_string("str__you_see_the_banner_of_your_wifehusband_s7_over_the_castle_gate")"),
    (else_try),
        (ge,":party_slot_010",0),
        (str_store_string,s11,":str_store_string()"),
    (else_try),
...
(else_try),
    ...
    (else_try),
        (gt,":party_slot_010",-1),
        (troop_slot_eq,":party_slot_010",30,"trp_player"),
        (str_store_string,s11,":str_store_string("str__the_banner_of_your_wifehusband_s7_flies_over_the_town_gates")"),
    (else_try),
        (ge,":party_slot_010",0),
        (str_store_string,s11,":str_store_string()"),
    (else_try),
...
(try_begin),
    ...
    (str_store_string,s12,":str_store_string("@{!} {s3} ({reg9}).")"),
(try_end),
(str_clear, 13),
(try_begin),
    (gt,":::entry_to_town_forbidden",0),
    (str_store_string,s13,":str_store_string()"),
(else_try),
    (faction_slot_eq,":party_faction_011",4,6),
    (faction_slot_eq,":party_faction_011",5,"$current_town"),
    (str_store_string,s13,":str_store_string("str__the_lord_is_currently_holding_a_feast_in_his_hall")"),
(try_end),
(try_begin),
    (eq,1,1),
    ...
    (else_try),
        ...
        (try_begin),
            (party_slot_eq,"$current_town",0,3),
            (str_store_string,s13,":str_store_string("str_town_nighttime")"),
        (try_end),
    (try_end),
(try_end),
(try_begin),
...
(try_begin),
    ...
    (str_store_string,s8,":str_store_string("str__however_you_have_sufficiently_distinguished_yourself_to_be_invited_to_attend_the_ongoing_feast_in_the_lords_castle")"),
(try_end),
],
[
]),
("town_tournament_won", 512, 
  ...
  "none", [
(str_store_string,s3,":str_store_party_name(_current_town)"),
(call_script, "script_change_troop_renown", "trp_player", 20),
(call_script, "script_change_player_relation_with_center", "$current_town", 1),
(add_xp_to_troop,250,"trp_player"),
(call_script, "script_troop_add_gold", "trp_player", 200), # reg9
(str_clear, 8),
...
(try_begin),
    ...
    (str_store_string,s8,":str_store_string("@Moreover)"),
(try_end),
(try_begin),
    (this_or_next|eq,":::players_kingdom",":::g_encountered_party_faction"),
    ...
    (faction_slot_eq,"$g_encountered_party_faction",4,6),
    (faction_slot_eq,"$g_encountered_party_faction",5,"$g_encountered_party"),
    (str_store_string,s8,":str_store_string("str_s8_you_are_also_invited_to_attend_the_ongoing_feast_in_the_castle")"),
(try_end),
...
(str_store_string,s1,":str_store_troop_name(troop_slot_002)"),
(try_begin),
...
(else_try),
    ...
    (try_begin),
        ...
        (str_store_string,s1,":str_store_string("@Victory is yours! You have won this melee)"),
    (else_try),
        (eq,":::g_tournament_player_team_won",0),
        (str_store_string,s1,":str_store_string("@You have been bested in this melee,but the master of ceremonies declares a recognition of your skill and bravery)"),
    (try_end),
    (assign,reg1,":var001"),
...
(try_for_range, ":slot_no_002", 0, ":var001"),
    ...
    (str_store_string,s12,":str_store_troop_name(troop_slot_003)"),
    (str_store_string,s11,":str_store_string("@{!}{s11}^{s12}")"),
(try_end),
],
[
]),
...
(else_try),
    (assign,1,0), # reg3
    (str_store_string,s1,":str_store_troop_name(var002)"),
(try_end),
(assign,":var003",3000),
(try_begin),
    (party_slot_eq,"$current_town",0,3),
...
(str_store_string,s19,":str_store_troop_name(quest_slot_001)"),
...
(str_store_string,s3,":str_store_party_name(_current_town)"),
(quest_get_slot,":quest_slot_001","qst_collect_taxes",6),
(str_store_string,s1,":str_store_troop_name(quest_slot_001)"),
(quest_get_slot,reg3,"qst_collect_taxes",22),
...
(str_store_string,s0,":str_store_troop_name_by_count("trp_trainee_peasant",random_x_005)"),
],
[
]),
...
(str_store_string,s0,":str_store_troop_name_by_count("trp_trainee_peasant",_g_train_peasants_against_bandits_num_peasants)"),
(try_begin),
    (eq,":::g_train_peasants_against_bandits_training_succeeded",0),
    (str_store_string,s0,":str_store_string()"),
(else_try),
    (str_store_string,s0,":str_store_string("@After beating your last opponent)"),
...
(try_begin),
    (eq,":::g_battle_result",1),
    (str_store_string,s9,":str_store_string("@The bandits are broken! Those few who remain alive and conscious run off with their tails between their legs)"),
...
(try_begin),
    (ge,":::cheat_mode",1),
    (str_store_string,s1,":str_store_string("str___hardship_index_reg0_avg_towns_reg1_avg_villages_reg2__")"),
...
(try_for_range, ":itm_004", ":itm.spice", ":itm.siege_supply"),
    ...
    (str_store_string,s3,":str_store_item_name(itm_004)"),
    (assign,reg1,":var006"),
    (assign,reg2,":var007"),
    (assign,reg3,":var005"),
    (assign,reg4,":party_slot_012"),
    ...
    (str_store_string,s4,":str_store_string(item_slot_024)"),
    (str_store_string,s1,":str_store_string("str___s3_price_"),
(try_end),
],
[
]),
...
(try_begin),
    (le,":var003",0),
    (str_store_string,s2,":str_store_string("@However)"),
(else_try),
    (try_begin),
        (ge,":var016",0),
        (assign,reg6,":var018"),
        (str_store_string,s4,":str_store_item_name(var016)"),
        (str_store_string,s5,":str_store_party_name(var017)"),
        (str_store_string,s3,":str_store_string()"),
    (try_end),
    (try_begin),
        (ge,":var013",0),
        (assign,reg6,":var015"),
        (str_store_string,s4,":str_store_item_name(var013)"),
        (str_store_string,s5,":str_store_party_name(var014)"),
        (str_store_string,s3,":str_store_string()"),
    (try_end),
    (try_begin),
        (ge,":var010",0),
        (assign,reg6,":var012"),
        (str_store_string,s4,":str_store_item_name(var010)"),
        (str_store_string,s5,":str_store_party_name(var011)"),
        (str_store_string,s3,":str_store_string()"),
    (try_end),
    (try_begin),
        (ge,":var007",0),
        (assign,reg6,":var009"),
        (str_store_string,s4,":str_store_item_name(var007)"),
        (str_store_string,s5,":str_store_party_name(var008)"),
        (str_store_string,s3,":str_store_string()"),
    (try_end),
    (try_begin),
        (ge,":var004",0),
        (assign,reg6,":var006"),
        (str_store_string,s4,":str_store_item_name(var004)"),
        (str_store_string,s5,":str_store_party_name(var005)"),
        (str_store_string,s3,":str_store_string()"),
    (try_end),
    (str_store_string,s2,":str_store_string("@{0?You find:{s1} finds} out the following:^{s3}")"), # reg3
(try_end),
],
[
]),
...
(else_try),
    ...
    (str_store_string,s12,":str_store_troop_name(troop_id_003)"),
    (try_begin),
        (eq,":var001",0),
        (str_store_string,s11,":str_store_string("str_s11_unfortunately_s12_was_wounded_and_had_to_be_left_behind")"),
    (else_try),
        (str_store_string,s11,":str_store_string("str_s11_also_s12_was_wounded_and_had_to_be_left_behind")"),
    (try_end),
    (assign,":var001",1),
...
(assign,reg12,reg0),
(str_store_string,s1,":str_store_troop_name(_g_ransom_offer_troop)"),
(store_troop_faction,":troop_faction_001","$g_ransom_offer_troop"),
(str_store_string,s2,":str_store_faction_name(troop_faction_001)"),
],
[
]),
("training_ground", 0, 
...
(try_begin),
    ...
    (try_for_range, ":slot_no_010", 2, ":var009"),
        ...
        (try_for_range, ":stack_no_014", 0, ":var013"),
            ...
            (str_store_string,s1,":str_store_troop_name_by_count(troop_slot_012,troop_slot_011)"),
    ...
    (try_for_range, ":slot_no_017", 0, ":::g_training_ground_training_num_enemies"),
        ...
        (try_for_range, ":stack_no_014", 0, ":var013"),
            ...
            (str_store_string,s1,":str_store_troop_name(troop_slot_012)"),
            (str_store_string,s2,":str_store_string()"),
        (try_end),
    (try_end),
(try_end),
...
(try_end),
(faction_get_slot,":faction_slot_001","$players_kingdom",11),
(str_store_string,s15,":str_store_troop_name(faction_slot_001)"),
(str_store_string,s23,":str_store_faction_name(_players_kingdom)"),
],
[
]),
...
(try_begin),
    (eq,reg0,1),
    (str_store_string,s9,":str_store_string(1)"),
(try_end),
(str_store_string,s8,":str_store_troop_name(quest_slot_001)"),
...
(str_store_string,s8,":str_store_troop_name(faction_slot_001)"),
],
[
]),
...
(str_store_string,s8,":str_store_troop_name(faction_slot_001)"),
(str_store_string,s9,":str_store_party_name(quest_slot_002)"),
],
[
]),
...
(str_store_string,s8,":str_store_troop_name(_g_invite_faction_lord)"),
(str_store_string,s9,":str_store_faction_name(_g_invite_faction)"),
],
[
]),
...
(str_store_string,s8,":str_store_troop_name(_g_invite_faction_lord)"),
(str_store_string,s9,":str_store_faction_name(_g_invite_faction)"),
(str_store_string,s2,":str_store_party_name(_g_invite_offered_center)"),
],
[
]),
...
(str_store_string,s3,":str_store_troop_name(_g_invite_faction_lord)"),
(str_store_string,s5,":str_store_string("@{!}{s1}")"),
],
[
]),
("question_peace_offer", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_faction_name(_g_notification_var1)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,65),
(position_set_y,0,30),
(position_set_z,0,170),
set_game_tableau_mesh(_g_notification_var1,"$g_notification_var1",
],
[
]),
("notification_truce_expired", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_faction_name(_g_notification_var1)"),
(str_store_string,s2,":str_store_faction_name(_g_notification_var2)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,65),
(position_set_y,0,30),
(position_set_z,0,170),
...
("notification_feast_quest_expired", 0, 
  "{s10}", 
  "none", [
(str_store_string,s10,":str_store_string("str_feast_quest_expired")"),
],
[
]),
("notification_sortie_possible", 0, 
  ...
  "none", [
(str_store_string,s4,":str_store_party_name(_g_notification_var1)"),
...
(str_store_string,s5,":str_store_faction_name(var002)"),
(store_troop_faction,":troop_faction_003",":troop_id_001"),
(str_store_string,s7,":str_store_faction_name(troop_faction_003)"),
...
(try_begin),
    ...
    (str_store_string,s7,":str_store_troop_name(faction_slot_003)"),
...
(else_try),
    ...
    (str_store_string,s6,":str_store_troop_name(faction_slot_003)"),
    (troop_get_type,reg4,":troop_id_001"),
    ...
    (try_begin),
        ...
        (str_store_string,s10,":str_store_faction_name(troop_faction_004)"),
...
(try_begin),
    ...
    (str_store_string,s3,":str_store_faction_name(party_faction_003)"),
    (str_store_string,s4,":str_store_faction_name(party_slot_004)"),
    (faction_get_slot,":faction_slot_005",":party_slot_004",11),
    (str_store_string,s5,":str_store_troop_name(faction_slot_005)"),
    (str_store_string,s9,":str_store_string("str_local_notables_from_s1_a_village_claimed_by_the_s4_have_been_mistreated_by_their_overlords_from_the_s3_and_petition_s5_for_protection")"),
...
(else_try),
    ...
    (str_store_string,s1,":str_store_party_name(party_id_001)"),
    (str_store_string,s2,":str_store_party_name(var002)"),
    (store_random_in_range,":random_x_006",0,3),
    (try_begin),
        (eq,":random_x_006",0),
        (str_store_string,s9,":str_store_string("str_villagers_from_s1_stole_some_cattle_from_s2")"),
        (display_log_message,"@There has been an alleged border incident: {s9}"),
        (call_script, "script_add_log_entry", 72, ":party_id_001", ":var002", -1, ":party_faction_003"),
    (else_try),
        (eq,":random_x_006",1),
        (str_store_string,s9,":str_store_string("str_villagers_from_s1_abducted_a_woman_from_a_prominent_family_in_s2_to_marry_one_of_their_boys")"),
        (display_log_message,"@There has been an alleged border incident: {s9}"),
        (call_script, "script_add_log_entry", 73, ":party_id_001", ":var002", -1, ":party_faction_003"),
    (else_try),
        (eq,":random_x_006",2),
        (str_store_string,s9,":str_store_string("str_villagers_from_s1_killed_some_farmers_from_s2_in_a_fight_over_the_diversion_of_a_stream")"),
        (display_log_message,"@There has been an alleged border incident: {s9}"),
...
(position_set_y,0,30),
(position_set_z,0,170),
set_game_tableau_mesh("fac_player_supporters_faction","fac_player_supporters_faction",
...
(try_for_range, ":p_001", ":p.town_1", ":p.village_1"),
    ...
    (try_end),
    (str_store_string,s12,":str_store_party_name(_g_player_court)"),
(try_end),
],
[
]),
...
(try_begin),
    ...
    (str_store_string,s9,":str_store_string("str_your_new_minister_")"),
(else_try),
    (str_store_string,s10,":str_store_troop_name(_g_player_minister)"),
    (str_store_string,s9,":str_store_string("str_s10_is_your_new_minister_and_")"),
(try_end),
(try_begin),
...
(try_begin),
    (is_between,"$g_player_court","p_town_1","p_salt_mine"),
    (str_store_string,s10,":str_store_party_name(_g_player_court)"),
    (str_store_string,s11,":str_store_party_name(_g_player_court)"),
(else_try),
    (str_store_string,s10,":str_store_string("str_your_previous_court_some_time_ago")"),
    (str_store_string,s11,":str_store_string("str_your_previous_court_some_time_ago")"),
(try_end),
(assign,"$g_player_court",-1),
(str_store_string,s14,":str_store_string("str_after_to_the_fall_of_s11_your_court_has_nowhere_to_go")"),
(try_begin),
    (faction_slot_eq,"fac_player_supporters_faction",21,2),
    (str_store_string,s14,":str_store_string("str_as_you_no_longer_maintain_an_independent_kingdom_you_no_longer_maintain_a_court")"),
(try_end),
(try_for_range, ":p_001", ":p.town_1", ":p.village_1"),
    (eq,":::g_player_court",-1),
    (store_faction_of_party, ":party_faction_002", ":p_001"),
    (try_begin),
        ...
        (str_store_string,s11,":str_store_party_name(_g_player_court)"),
    (try_end),
    (str_store_string,s14,":str_store_string("str_due_to_the_fall_of_s10_your_court_has_been_relocated_to_s12")"),
(try_end),
(try_for_range, ":p_001", ":p.town_1", ":p.village_1"),
    (eq,":::g_player_court",-1),
    (store_faction_of_party, ":party_faction_002", ":p_001"),
    ...
    (str_store_string,s11,":str_store_party_name(_g_player_court)"),
    (str_store_string,s9,":str_store_troop_name(party_slot_004)"),
    (str_store_string,s14,":str_store_string("str_after_to_the_fall_of_s10_your_faithful_vassal_s9_has_invited_your_court_to_s11_")"),
(try_end),
(try_begin),
    (faction_slot_eq,"fac_player_supporters_faction",21,2),
    (str_store_string,s14,":str_store_string("str_as_you_no_longer_maintain_an_independent_kingdom_you_no_longer_maintain_a_court")"),
(try_end),
(str_store_string,s12,":str_store_string(14)"),
],
[
]),
...
("notification_player_wedding_day", 4096, 
  ...
  "none", [
(set_background_mesh, "mesh_pic_messenger"),
(str_store_string,s8,":str_store_troop_name(_g_notification_var1)"),
(str_store_string,s10,":str_store_party_name(_g_notification_var2)"),
],
[
]),
...
(str_store_string,s9,":str_store_faction_name(troop_faction_001)"),
(str_store_string,s10,":str_store_party_name(_g_notification_var2)"),
(str_clear, 12),
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s12,":str_store_string("str_feast_wedding_opportunity")"),
    (try_end),
(try_end),
(str_store_string,s11,":str_store_string("str_s8_wishes_to_inform_you_that_the_lords_of_s9_will_be_gathering_for_a_feast_at_his_great_hall_in_s10_and_invites_you_to_be_part_of_this_august_assembly")"),
(try_begin),
    (neg|eq,":::g_notification_var1",0),
    (str_store_string,s11,":str_store_string("str_the_great_lords_of_your_kingdom_plan_to_gather_at_your_hall_in_s10_for_a_feast")"),
(try_end),
(str_store_string,s11,":str_store_string("@{!}{s11}{s12}")"),
(try_begin),
    (ge,":::cheat_mode",1),
...
("notification_center_under_siege", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_party_name(_g_notification_var1)"),
(str_store_string,s2,":str_store_troop_name(_g_notification_var2)"),
(store_troop_faction,":troop_faction_001","$g_notification_var2"),
(str_store_string,s3,":str_store_faction_name(troop_faction_001)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,62),
(position_set_y,0,30),
(position_set_z,0,170),
...
("notification_troop_left_players_faction", 0, 
  ...
  "none", [
(str_store_string,s1,":str_store_troop_name(_g_notification_var1)"),
(str_store_string,s2,":str_store_faction_name(_players_kingdom)"),
(str_store_string,s3,":str_store_faction_name(_g_notification_var2)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,55),
(position_set_y,0,20),
...
(str_store_string,s1,":str_store_troop_name(_g_notification_var1)"),
(str_store_string,s2,":str_store_faction_name(_g_notification_var2)"),
(str_store_string,s3,":str_store_faction_name(_players_kingdom)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,55),
(position_set_y,0,20),
(position_set_z,0,100),
...
set_game_tableau_mesh(var001,":var001",
],
[
]),
...
("notification_rebels_switched_to_faction", 0, 
  ...
  "none", [
(str_store_string,s11,":str_store_faction_name(_g_notification_var1)"),
(str_store_string,s12,":str_store_troop_name(_g_notification_var2)"),
(set_fixed_point_multiplier, 100),
(position_set_x,0,65),
(position_set_y,0,30),
(position_set_z,0,170),
...
("notification_player_feast_in_progress", 0, 
  ...
  "none", [
(str_store_string,s11,":str_store_party_name(_g_notification_var1)"),
],
[
]),
...
(assign,":troop_id_001","$g_notification_var1"),
(assign,":var002","$g_notification_var2"),
(str_store_string,s15,":str_store_troop_name(troop_id_001)"),
(str_store_string,s10,":str_store_party_name(var002)"),
...
(assign,":var005",reg0),
(str_store_string,s16,":str_store_troop_name(var005)"),
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s14,":str_store_string("str_as_brief_as_our_separation_has_been_the_longing_in_my_heart_to_see_you_has_made_it_seem_as_many_years")"),
    (else_try),
        (str_store_string,s14,":str_store_string("str_although_it_has_only_been_a_short_time_since_your_departure_but_i_would_be_most_pleased_to_see_you_again")"),
    (try_end),
(else_try),
    (ge,":cur_hours_003",336),
    (try_begin),
        (troop_slot_eq,":troop_id_001",52,24),
        (str_store_string,s14,":str_store_string("str_although_i_have_received_no_word_from_you_for_quite_some_time_i_am_sure_that_you_must_have_been_very_busy_and_that_your_failure_to_come_see_me_in_no_way_indicates_that_your_attentions_to_me_were_insincere_")"),
    (else_try),
        (troop_slot_eq,":troop_id_001",52,25),
        (str_store_string,s14,":str_store_string("str_i_trust_that_you_have_comported_yourself_in_a_manner_becoming_a_gentleman_during_our_long_separation_")"),
    (else_try),
        (str_store_string,s14,":str_store_string("str_it_has_been_many_days_since_you_came_and_i_would_very_much_like_to_see_you_again")"),
    (try_end),
(try_end),
(str_clear, 12),
(str_clear, 18),
(try_begin),
    ...
    (str_store_string,s12,":str_store_string("str__you_should_ask_my_s11_s16s_permission_but_i_have_no_reason_to_believe_that_he_will_prevent_you_from_coming_to_see_me")"),
    (str_store_string,s18,":str_store_string("str__you_should_first_ask_her_s11_s16s_permission")"),
(else_try),
    (troop_slot_eq,":var005",38,-1),
    (str_store_string,s12,":str_store_string("str__alas_as_we_know_my_s11_s16_will_not_permit_me_to_see_you_however_i_believe_that_i_can_arrange_away_for_you_to_enter_undetected")"),
(else_try),
    (troop_slot_eq,":var005",38,1),
    (str_store_string,s12,":str_store_string("str__as_my_s11_s16_has_already_granted_permission_for_you_to_see_me_i_shall_expect_your_imminent_arrival")"),
(try_end),
],
[
]),
...
(str_store_string,s11,":str_store_troop_name(_love_interest_in_town)"),
(try_begin),
    (eq,1,1),
...
(try_begin),
    ...
    (str_store_string,s12,":str_store_string("str_the_guards_at_the_gate_have_been_ordered_to_allow_you_through_you_might_be_imagining_things_but_you_think_one_of_them_may_have_given_you_a_wink")"),
(else_try),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (try_begin),
                (is_between,"$g_encountered_party","p_town_1","p_castle_1"),
                (str_store_string,s12,":str_store_string("str_the_guards_glare_at_you_and_you_know_better_than_to_ask_permission_to_enter_however_as_you_walk_back_towards_your_lodgings_an_elderly_lady_dressed_in_black_approaches_you_i_am_s11s_nurse_she_whispers_urgently_don_this_dress_and_throw_the_hood_over_your_face_i_will_smuggle_you_inside_the_castle_to_meet_her_in_the_guise_of_a_skullery_maid__the_guards_will_not_look_too_carefully_but_i_beg_you_for_all_of_our_sakes_be_discrete")"),
                (assign,"$nurse_assists_entry",1),
            (else_try),
                (str_store_string,s12,":str_store_string("str_the_guards_glare_at_you_and_you_know_better_than_to_ask_permission_to_enter_however_as_you_walk_back_towards_your_lodgings_an_elderly_lady_dressed_in_black_approaches_you_i_am_s11s_nurse_she_whispers_urgently_wait_for_a_while_by_the_spring_outside_the_walls_i_will_smuggle_her_ladyship_out_to_meet_you_dressed_in_the_guise_of_a_shepherdess_but_i_beg_you_for_all_of_our_sakes_be_discrete")"),
                (assign,"$nurse_assists_entry",2),
            (try_end),
        (try_end),
    (else_try),
        (str_store_string,s12,":str_store_string("str_the_guards_glare_at_you_and_you_know_better_than_to_ask_permission_to_enter_however_as_you_walk_back_towards_your_lodgings_an_elderly_lady_dressed_in_black_approaches_you_i_am_s11s_nurse_she_whispers_urgently_her_ladyship_asks_me_to_say_that_yearns_to_see_you_but_that_you_should_bide_your_time_a_bit_her_ladyship_says_that_to_arrange_a_clandestine_meeting_so_soon_after_your_last_encounter_would_be_too_dangerous")"),
    (try_end),
(try_end),
],
[
...
(else_try),
    ...
    (str_store_string,s4,":str_store_troop_name_plural(troop_id_003)"),
    (str_store_string,s5,":str_store_string("str_bandit_approach_defile")"),
    (try_begin),
        (eq,":troop_id_003","trp_desert_bandit"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_defile")"),
    (else_try),
        (eq,":troop_id_003","trp_mountain_bandit"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_cliffs")"),
    (else_try),
        (eq,":troop_id_003","trp_forest_bandit"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_swamp")"),
    (else_try),
        (eq,":troop_id_003","trp_taiga_bandit"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_swamp")"),
    (else_try),
        (eq,":troop_id_003","trp_steppe_bandit"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_thickets")"),
    (else_try),
        (eq,":troop_id_003","trp_sea_raider"),
        (str_store_string,s5,":str_store_string("str_bandit_approach_cove")"),
    (try_end),
    (try_begin),
        (party_slot_eq,"$g_encountered_party",8,0),
        (str_store_string,s3,":str_store_string("str_bandit_hideout_preattack")"),
    (else_try),
        (party_get_template_id,":party_template_id_002","$g_encountered_party"),
        (try_begin),
            (eq,":party_template_id_002","pt_looter_lair"),
            (party_slot_eq,"$g_encountered_party",8,1),
            (str_store_string,s3,":str_store_string("str_lost_startup_hideout_attack")"),
        (else_try),
            (party_slot_eq,"$g_encountered_party",8,1),
            (str_store_string,s3,":str_store_string("str_bandit_hideout_failure")"),
        (else_try),
            (party_slot_eq,"$g_encountered_party",8,2),
            (str_store_string,s3,":str_store_string("str_bandit_hideout_success")"),
        (try_end),
    (try_end),
(try_end),
],
...
(str_store_string,s10,":str_store_troop_name(faction_slot_003)"),
(try_begin),
    (eq,":var001",1),
    (str_store_string,s11,":str_store_string("str_the_marshalship")"),
(else_try),
    (str_store_string,s11,":str_store_party_name(var001)"),
(try_end),
(str_store_string,s12,":str_store_troop_name(var002)"),
],
[
]),
("notification_player_faction_political_issue_resolved_for_player", 0, 
  ...
  "none", [
(faction_get_slot,":faction_slot_001","$players_kingdom",11),
(str_store_string,s10,":str_store_troop_name(faction_slot_001)"),
(faction_get_slot,":faction_slot_002","$players_kingdom",64),
(try_begin),
    (eq,":faction_slot_002",1),
    (str_store_string,s11,":str_store_string("str_the_marshalship")"),
    (str_store_string,s12,":str_store_string("@^^Note that so long as you remain marshal,if you are awaiting a feast,either for a wedding or for other purposes)"),
(else_try),
    (str_clear, 12),
    (str_store_string,s11,":str_store_party_name(faction_slot_002)"),
(try_end),
],
[
]),
("start_phase_2_5", 512, 
  "{!}{s16}", 
  "none", [
(str_store_string,s1,":str_store_party_name(_g_starting_town)"),
(str_store_string,s16,":str_store_string(_g_journey_string)"),
],
[
]),
("start_phase_3", 512, 
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s11,":str_store_string("str_killed_bandit_at_alley_fight")"),
    (else_try),
        (str_store_string,s11,":str_store_string("str_wounded_by_bandit_at_alley_fight")"),
    (try_end),
...
(else_try),
    (eq,":::current_startup_quest_phase",3),
    (str_store_string,s11,":str_store_string("str_merchant_and_you_call_some_townsmen_and_guards_to_get_ready_and_you_get_out_from_tavern")"),
(else_try),
    (eq,":::current_startup_quest_phase",4),
    (try_begin),
        (eq,":::g_killed_first_bandit",1),
        (str_store_string,s11,":str_store_string("str_town_fight_ended_you_and_citizens_cleaned_town_from_bandits")"),
    (else_try),
        (str_store_string,s11,":str_store_string("str_town_fight_ended_you_and_citizens_cleaned_town_from_bandits_you_wounded")"),
    (try_end),
(try_end),
],
[
...
(try_begin),
    ...
    (try_begin),
        ...
        (str_store_string,s11,":str_store_string("str_lost_tavern_duel_ordinary")"),
    (else_try),
        (agent_get_troop_id,":troop_id_001", "$g_main_attacker_agent"),
        (try_begin),
            (eq,":troop_id_001","trp_hired_assassin"),
            (str_store_string,s11,":str_store_string("str_lost_tavern_duel_assassin")"),
        (try_end),
    (try_end),
(try_end),
...
("establish_court", 512, 
  ...
  "none", [
(str_store_string,s4,":str_store_party_name(_g_encountered_party)"),
],
[
]),
...
(faction_get_slot,":faction_slot_003","$players_kingdom",11),
(str_store_string,s4,":str_store_troop_name(faction_slot_003)"),
