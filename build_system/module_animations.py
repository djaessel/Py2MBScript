...
["ready_slashright_twohanded", acf_anim_length(100)|acf_right_cut|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [0.35, "slashright_twohanded", 10, 18, blend_in_ready, ],
],
...
["release_slashright_twohanded_continue", acf_anim_length(100)|0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.5, "slashright_twohanded", 38, 61, blend_in_continue, ],
],
["blocked_slashright_twohanded", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.3, "anim_human", 25725, 25720, blend_in_parry, ],
],
["parried_slashright_twohanded", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [0.6, "anim_human", 25725, 25720, blend_in_parry, ],
],
["ready_slashleft_twohanded", acf_anim_length(100)|acf_right_cut|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [0.35, "slashleft_twohanded", 12, 16, blend_in_ready, ],
],
...
["release_slashleft_twohanded_continue", acf_anim_length(100)|0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.5, "slashleft_twohanded", 38, 52, blend_in_continue, ],
],
["blocked_slashleft_twohanded", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.3, "anim_human", 26425, 26420, blend_in_parry, ],
],
["parried_slashleft_twohanded", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [0.6, "anim_human", 26425, 26420, blend_in_parry, ],
],
["ready_thrust_twohanded", acf_anim_length(100)|acf_thrust|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [0.35, "anim_human", 26000, 26010, blend_in_ready, ],
],
["release_thrust_twohanded", acf_anim_length(100)|acf_thrust|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  [0.61, "anim_human", 26010, 26031, blend_in_release, ],
],
["release_thrust_twohanded_continue", acf_anim_length(100)|0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.1, "anim_human", 26031, 26040, blend_in_continue, ],
],
["blocked_thrust_twohanded", acf_anim_length(100)|0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [0.3, "anim_human", 26015, 26016, blend_in_parry, ],
],
["parried_thrust_twohanded", acf_anim_length(100)|0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  [0.6, "anim_human", 26015, 26016, blend_in_parry, ],
],
