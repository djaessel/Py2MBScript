...
(try_begin),
    ...
    (store_sub, ":var002", ":var002", "fac_kingdom_1"),
    (init_position,1),
    (position_set_y,1,-5),
    (position_set_x,1,-45),
...
(try_begin),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (store_sub, ":troop_slot_003", ":troop_slot_003", "spr_banner_a"),
...
(store_add, ":faction_id_001", ":faction_id_001", "fac_player_supporters_faction"),
(store_add, ":faction_id_002", ":faction_id_002", "fac_player_supporters_faction"),
(set_fixed_point_multiplier, 100),
(try_begin),
    (eq,1,1),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (store_sub, ":troop_slot_004", ":troop_slot_004", "spr_banner_a"),
