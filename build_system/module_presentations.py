...
(assign,":var005",0),
(try_for_range, ":mesh_006", "mesh_banner_a01", "mesh_banner_f21"),
    (assign,":var007",0),
    (try_for_range, ":fac_008", "fac_kingdom_1", "fac_kingdoms_end"),
        (try_begin),
...
(else_try),
    ...
    (try_for_range, ":var006", "mesh_banner_a01", ":var005"),
        (assign,":var007",0),
        (try_for_range, ":fac_008", "fac_kingdom_1", "fac_kingdoms_end"),
            (try_begin),
        ...
        (try_begin),
            ...
            (try_begin),
                (eq,":var002",":var004"),
                (store_sub, ":var009", ":var006", "mesh_banner_a01"),
...
(try_for_range, ":trp_001", "trp_quick_battle_troop_1", "trp_quick_battle_troops_end"),
    (str_store_troop_name,s0,":trp_001"),
    (overlay_add_item, "$g_presentation_obj_custom_battle_designer_18", 0),
(try_end),
(store_sub, ":trp_001", "$g_quick_battle_troop", "trp_quick_battle_troop_1"),
(overlay_set_val, "$g_presentation_obj_custom_battle_designer_18", ":trp_001"),
(store_mul, ":trp_001", "$g_quick_battle_troop", 2),
(create_mesh_overlay_with_tableau_material, reg0, -1, "tableau_game_party_window", ":trp_001"),
(position_set_x,1,25),
...
(position_set_y,1,700),
(overlay_set_position, reg0, 1),
(store_sub, ":var002", "$g_quick_battle_troop", "trp_quick_battle_troop_1"),
(store_add, ":var002", ":var002", "str_quick_battle_troop_1"),
...
(try_begin),
    ...
    (try_for_range, ":scn_003", "scn_quick_battle_scene_1", "scn_quick_battle_scene_4"),
        (store_sub, ":var004", ":scn_003", "scn_quick_battle_scene_1"),
        (store_add, ":var004", ":var004", "str_quick_battle_scene_1"),
    ...
    (try_begin),
        ...
        (store_sub, ":var005", "$g_quick_battle_map", "scn_quick_battle_scene_1"),
    ...
    (try_end),
(else_try),
    (try_for_range, ":scn_003", "scn_quick_battle_scene_4", "scn_quick_battle_maps_end"),
        (store_sub, ":var004", ":scn_003", "scn_quick_battle_scene_1"),
        (store_add, ":var004", ":var004", "str_quick_battle_scene_1"),
        (overlay_add_item, "$g_presentation_obj_custom_battle_designer_1", ":var004"),
    (try_end),
    (try_begin),
        ...
        (store_sub, ":var005", "$g_quick_battle_map", "scn_quick_battle_scene_4"),
        (overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", ":var005"),
    (else_try),
        (overlay_set_val, "$g_presentation_obj_custom_battle_designer_1", 0),
    ...
    (try_end),
(try_end),
(store_sub, ":var006", "$g_quick_battle_map", "scn_quick_battle_scene_1"),
(store_add, ":var006", ":var006", "mesh_cb_ui_maps_scene_01"),
...
(try_begin),
    ...
    (overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", 0),
(else_try),
    (try_for_range, ":fac_009", "fac_kingdom_1", "fac_kingdoms_end"),
...
(try_begin),
    ...
    (store_sub, ":var010", ":var010", "fac_kingdom_1"),
    (overlay_set_val, "$g_presentation_obj_custom_battle_designer_4", ":var010"),
(else_try),
    (store_sub, ":var011", "$g_quick_battle_team_1_faction", "fac_kingdom_1"),
...
(else_try),
    (store_sub, ":var012", "$g_quick_battle_team_2_faction", "fac_kingdom_1"),
...
(try_begin),
    ...
    (try_begin),
        (eq,"$g_quick_battle_game_type",0),
        (store_add, "$g_quick_battle_map", ":var002", "scn_quick_battle_scene_1"),
    (else_try),
        (store_add, "$g_quick_battle_map", ":var002", "scn_quick_battle_scene_4"),
    (try_end),
    (presentation_set_duration, 0),
...
(else_try),
    ...
    (try_begin),
        ...
        (try_end),
        (store_add, "$g_quick_battle_team_1_faction", "$g_quick_battle_team_1_faction", "fac_kingdom_1"),
        (store_add, "$g_quick_battle_team_2_faction", "$g_quick_battle_team_2_faction", "fac_kingdom_1"),
    ...
    (else_try),
        ...
        (store_sub, ":var004", ":var004", "fac_kingdom_1"),
        (val_add, ":var004", 1),
...
(else_try),
    ...
    (try_begin),
        ...
        (store_sub, ":var013", ":var013", "fac_kingdom_1"),
        (try_begin),
            (eq,":var002",":var013"),
            (assign,"$g_quick_battle_team_1_faction","fac_outlaws"),
        (else_try),
            (store_add, "$g_quick_battle_team_1_faction", ":var002", "fac_kingdom_1"),
        (try_end),
    (try_end),
(else_try),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (assign,"$g_quick_battle_team_2_faction","fac_outlaws"),
        (else_try),
            (store_add, "$g_quick_battle_team_2_faction", ":var002", "fac_kingdom_1"),
        (try_end),
    (try_end),
    (presentation_set_duration, 0),
    (start_presentation, "prsnt_game_custom_battle_designer"),
(else_try),
    ...
    (store_add, "$g_quick_battle_troop", ":var002", "trp_quick_battle_troop_1"),
    (presentation_set_duration, 0),
    (start_presentation, "prsnt_game_custom_battle_designer"),
(else_try),
...
(try_for_range, ":var010", 0, ":var006"),
    ...
    (store_sub, ":var013", ":troop_slot_012", "scn_multi_scene_1"),
    (store_add, ":var013", ":var013", "str_multi_scene_1"),
...
(try_begin),
    ...
    (try_for_range, ":var014", 0, 9),
        (store_add, ":var013", ":var014", "str_multi_game_type_1"),
        (str_store_string,s0,":var013"),
...
(else_try),
    (assign,"$g_presentation_obj_admin_panel_10",-1),
    (store_add, ":var013", "$g_multiplayer_game_type", "str_multi_game_type_1"),
    (str_store_string,s0,":var013"),
    (create_text_overlay, reg0, 0),
    (position_set_x,1,385),
    (position_set_y,1,":var002"),
...
(else_try),
    ...
    (store_add, "$g_multiplayer_next_team_1_faction", ":var002", "fac_kingdom_1"),
...
(else_try),
    ...
    (else_try),
        (store_add, "$g_multiplayer_next_team_2_faction", ":var002", "fac_kingdom_1"),
    (try_end),
    (multiplayer_send_2_int_to_server, 17, 2, "$g_multiplayer_next_team_2_faction"),
    (presentation_set_duration, 0),
    (start_presentation, "prsnt_game_multiplayer_admin_panel"),
...
(else_try),
    ...
    (try_begin),
        (eq,"$g_multiplayer_game_type",8),
        (store_add, ":var003", "$g_multiplayer_ccoop_difficulty", "str_ccoop_easy"),
        (str_store_string,s0,":var003"),
        (str_store_string,s3,"str_ccoop_difficulty_s0"),
        (str_store_string,s2,"str_s2_s3"),
    (try_end),
    (store_current_scene,":cur_scene_004"),
    (store_sub, ":cur_scene_004", ":cur_scene_004", "scn_multi_scene_1"),
    (store_add, ":cur_scene_004", ":cur_scene_004", "str_multi_scene_1"),
...
(try_end),
(assign,":var006",0),
(try_for_range, ":trp_007", "trp_swadian_crossbowman_multiplayer", "trp_multiplayer_end"),
...
(try_for_range, ":var007", 30, ":var006"),
    (try_begin),
        ...
        (try_for_range, ":troop_id_010", "trp_swadian_crossbowman_multiplayer", ":var009"),
...
(try_begin),
    ...
    (try_begin),
        (eq,":var006",1),
        (try_for_range, ":trp_009", "trp_swadian_crossbowman_multiplayer_ai", "trp_swadian_crossbowman_multiplayer"),
...
(else_try),
    ...
    (try_begin),
        ...
        (try_for_range, ":trp_018", "trp_npc1_1", "trp_npc1_2"),
        ...
        (try_end),
        (store_sub, ":var019", "$g_presentation_obj_coop_companion_0", "trp_npc1_1"),
        (overlay_set_val, "$g_presentation_obj_coop_companion_select_0", ":var019"),
        (store_sub, ":var019", "$g_presentation_obj_coop_companion_1", "trp_npc1_1"),
    ...
    (position_set_y,1,507),
    (overlay_set_position, reg0, 1),
    (store_sub, ":var022", "$g_presentation_obj_coop_companion_0", "trp_npc1_1"),
    (store_add, ":var022", ":var022", "str_npc1_1"),
    ...
    (overlay_set_position, reg0, 1),
    (store_sub, ":var022", "$g_presentation_obj_coop_companion_1", "trp_npc1_1"),
    (store_add, ":var022", ":var022", "str_npc1_1"),
    (str_store_string,s0,":var022"),
    (create_text_overlay, reg0, 0),
    (position_set_x,1,750),
    ...
    (try_end),
    (assign,":var024",0),
    (try_for_range, ":trp_025", "trp_swadian_crossbowman_multiplayer_coop_tier_1", "trp_coop_faction_troop_templates_end"),
...
(else_try),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (else_try),
                (store_troop_faction,":troop_faction_011",":troop_id_010"),
                (store_sub, ":slot_no_012", ":troop_faction_011", "fac_kingdom_1"),
...
(try_begin),
    ...
    (else_try),
        ...
        (else_try),
            ...
            (else_try),
                (store_add, ":random_x_002", ":random_x_002", "trp_npc1_1"),
            (try_end),
            ...
            (try_begin),
                ...
                (store_sub, ":random_x_002", "$g_presentation_obj_coop_companion_0", "trp_npc1_1"),
                (store_add, ":random_x_002", ":random_x_002", "trp_npc1_1"),
        ...
        (else_try),
            ...
            (try_begin),
                ...
                (store_sub, ":random_x_002", "$g_presentation_obj_coop_companion_1", "trp_npc1_1"),
                (store_add, ":random_x_002", ":random_x_002", "trp_npc1_1"),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (else_try),
                    (assign,":var016",0),
                    (try_for_range, ":trp_017", "trp_swadian_crossbowman_multiplayer_coop_tier_1", "trp_coop_faction_troop_templates_end"),
...
(ti_on_presentation_load, [
(set_fixed_point_multiplier, 1000),
(store_sub, ":var001", "$g_multiplayer_team_1_faction", "fac_kingdom_1"),
(store_add, ":var001", ":var001", "mesh_flag_project_sw"),
(create_mesh_overlay, "$g_presentation_obj_flag_projection_display_1", ":var001"),
(store_sub, ":var001", ":var001", "mesh_flag_project_sw"),
(store_add, ":var001", ":var001", "mesh_flag_project_sw_miss"),
...
(try_begin),
    ...
    (store_sub, ":var001", "$g_multiplayer_team_2_faction", "fac_kingdom_1"),
    (store_add, ":var001", ":var001", "mesh_flag_project_sw"),
...
(try_for_range, ":var004", 0, ":var001"),
    ...
    (store_sub, ":var007", ":troop_slot_006", "scn_multi_scene_1"),
    (store_add, ":var007", ":var007", "str_multi_scene_1"),
...
(store_sub, ":var001", ":var001", "fac_kingdom_1"),
(try_begin),
...
(val_sub, ":var002", 40),
(assign,":button_overlay_003",-1),
(try_for_range, ":fac_004", "fac_kingdom_1", "fac_kingdoms_end"),
    (try_begin),
...
(try_for_range, ":var002", "$g_show_factions_list_button_list_first_index", "$g_show_factions_list_button_list_end_index"),
    (try_begin),
        ...
        (store_add, ":var003", ":var003", "fac_kingdom_1"),
        (presentation_set_duration, 0),
        (try_begin),
            (eq,"$g_multiplayer_factions_list_action_type",2),
            (try_begin),
...
(try_begin),
    ...
    (store_sub, ":var001", "$g_multiplayer_poll_value_to_show", "scn_multi_scene_1"),
    (store_add, ":var001", ":var001", "str_multi_scene_1"),
...
(else_try),
    ...
    (store_add, ":var001", "$g_tutorial_mouse_dir", "mesh_mouse_arrow_down"),
    (create_mesh_overlay, reg0, ":var001"),
    (position_set_x,1,800),
    (position_set_y,1,800),
    (overlay_set_size, reg0, 1),
...
(store_add, ":var005", ":var005", "mesh_banner_a01"),
...
(else_try),
    ...
    (store_add, ":var005", ":var002", "spr_banner_a"),
    ...
    (try_for_range, ":troop_id_008", "trp_npc1", ":var007"),
        ...
        (try_end),
    (try_end),
    (try_for_range, ":p_010", "p_town_1", "p_village_1"),
        (try_begin),
...
(store_add, ":troop_slot_001", ":troop_slot_001", "mesh_custom_banner_01"),
(troop_get_slot,":troop_slot_002","trp_player",99),
(val_max,":troop_slot_002",0),
(store_add, ":troop_slot_002", ":troop_slot_002", "mesh_custom_map_banner_01"),
...
(position_set_y,1,500),
(overlay_set_position, reg1, 1),
(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_22", "mesh_color_picker", "tableau_color_picker", ":troop_slot_003"),
(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_23", "mesh_color_picker", "tableau_color_picker", ":troop_slot_004"),
(position_set_x,1,200),
(position_set_y,1,565),
...
(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_17", ":troop_slot_001", "tableau_custom_banner_default", "trp_player"),
(try_begin),
    (eq,":troop_slot_002","mesh_custom_map_banner_01"),
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_18", ":troop_slot_002", "tableau_custom_banner_square", "trp_player"),
(else_try),
    (eq,":troop_slot_002","mesh_custom_map_banner_02"),
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_18", ":troop_slot_002", "tableau_custom_banner_short", "trp_player"),
(else_try),
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_18", ":troop_slot_002", "tableau_custom_banner_tall", "trp_player"),
(try_end),
...
(try_begin),
    ...
    (store_add, ":troop_slot_006", ":troop_slot_006", "mesh_custom_banner_charge_01"),
    ...
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_28", "mesh_color_picker", "tableau_color_picker", ":troop_slot_007"),
    (position_set_x,1,530),
    (position_set_y,1,255),
...
(try_begin),
    ...
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_29", "mesh_color_picker", "tableau_color_picker", ":troop_slot_007"),
    (position_set_x,1,530),
    (position_set_y,1,195),
...
(try_begin),
    ...
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_30", "mesh_color_picker", "tableau_color_picker", ":troop_slot_007"),
    (position_set_x,1,530),
    (position_set_y,1,135),
...
(try_begin),
    ...
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_custom_banner_31", "mesh_color_picker", "tableau_color_picker", ":troop_slot_007"),
    (position_set_x,1,530),
    (position_set_y,1,75),
...
(try_for_range, ":slot_no_005", 0, ":var003"),
    (create_image_button_overlay_with_tableau_material, reg1, -1, "tableau_positioning_selection", ":slot_no_005"),
    (position_set_x,1,":var001"),
    (position_set_y,1,":var002"),
    (val_add, ":var001", 125),
    (overlay_set_position, reg1, 1),
...
(assign,":var001",100),
(assign,":var002",600),
(try_for_range, ":mesh_003", "mesh_custom_banner_charge_01", "mesh_tableau_mesh_custom_banner"),
    ...
    (position_set_y,1,80),
    (overlay_set_size, reg1, 1),
    (store_sub, ":slot_no_004", ":mesh_003", "mesh_custom_banner_charge_01"),
...
(store_sub, ":var002", ":var002", "mesh_custom_banner_charge_01"),
(try_for_range, ":var003", 0, ":var002"),
    (try_begin),
        (troop_slot_eq,"trp_temp_array_a",":var003",":var001"),
...
(assign,":var001",75),
(assign,":var002",450),
(try_for_range, ":mesh_003", "mesh_custom_banner_bg", "mesh_custom_banner_charge_01"),
    (store_sub, ":slot_no_004", ":mesh_003", "mesh_custom_banner_bg"),
    (create_image_button_overlay_with_tableau_material, reg1, -1, "tableau_background_selection", ":slot_no_004"),
    (position_set_x,1,":var001"),
    (position_set_y,1,":var002"),
    (val_add, ":var001", 125),
    (try_begin),
...
(store_sub, ":var002", ":var002", "mesh_custom_banner_bg"),
(try_for_range, ":var003", 0, ":var002"),
    (try_begin),
        (troop_slot_eq,"trp_temp_array_a",":var003",":var001"),
...
(assign,":var001",435),
(assign,":var002",450),
(try_for_range, ":mesh_003", "mesh_custom_banner_01", "mesh_custom_banner_bg"),
    (store_sub, ":slot_no_004", ":mesh_003", "mesh_custom_banner_01"),
    (troop_set_slot,"trp_player",96,":slot_no_004"),
    (create_image_button_overlay_with_tableau_material, reg1, ":mesh_003", "tableau_custom_banner_default", "trp_player"),
    (position_set_x,1,":var001"),
    (position_set_y,1,":var002"),
    (val_add, ":var001", 130),
    (overlay_set_position, reg1, 1),
...
(store_sub, ":var002", ":var002", "mesh_custom_banner_01"),
(try_for_range, ":var003", 0, ":var002"),
    (try_begin),
        (troop_slot_eq,"trp_temp_array_a",":var003",":var001"),
...
(store_add, ":troop_slot_001", ":troop_slot_001", "mesh_custom_banner_bg"),
(assign,":var002",250),
(assign,":var003",150),
(try_for_range, ":mesh_004", "mesh_custom_map_banner_01", "mesh_custom_banner_01"),
    (store_sub, ":slot_no_005", ":mesh_004", "mesh_custom_map_banner_01"),
    (troop_set_slot,"trp_player",99,":slot_no_005"),
    (try_begin),
        (eq,":mesh_004","mesh_custom_map_banner_01"),
        (create_image_button_overlay_with_tableau_material, reg1, ":mesh_004", "tableau_custom_banner_square", "trp_player"),
    (else_try),
        (eq,":mesh_004","mesh_custom_map_banner_02"),
        (create_image_button_overlay_with_tableau_material, reg1, ":mesh_004", "tableau_custom_banner_short", "trp_player"),
    (else_try),
        (create_image_button_overlay_with_tableau_material, reg1, ":mesh_004", "tableau_custom_banner_tall", "trp_player"),
    (try_end),
...
(store_sub, ":var002", ":var002", "mesh_custom_map_banner_01"),
(try_for_range, ":var003", 0, ":var002"),
    (try_begin),
        (troop_slot_eq,"trp_temp_array_a",":var003",":var001"),
...
(try_for_range, ":var003", 0, 42),
    ...
    (assign,":var004",reg0),
    (create_image_button_overlay_with_tableau_material, reg1, "mesh_color_picker", "tableau_color_picker", ":var004"),
    (position_set_x,1,":var001"),
    (position_set_y,1,":var002"),
    (val_add, ":var001", 50),
    (try_begin),
...
(else_try),
    (assign,":var004",":var003"),
    (try_for_range, ":trp_005", "trp_kingdom_heroes_including_player_begin", "trp_knight_1_1_wife"),
        (try_begin),
            (ge,":var004",0),
        ...
        (try_begin),
            ...
            (try_begin),
                (lt,":var004",0),
                (assign,"$g_presentation_next_presentation","prsnt_marshall_selection"),
                (create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_troop_note_mesh", ":troop_id_006"),
                (position_set_x,1,300),
                (position_set_y,1,300),
                (overlay_set_size, reg1, 1),
...
(assign,":var009",0),
(assign,":var010",0),
(try_for_range, ":p_011", "p_town_1", "p_salt_mine"),
...
(assign,":var035",0),
(assign,":var036",0),
(try_for_range, ":trp_037", "trp_npc1", "trp_heroes_end"),
    (try_begin),
...
(assign,":var047",0),
(assign,":var048",0),
(try_for_range, ":trp_037", "trp_npc1", "trp_kingdom_1_lord"),
    (try_begin),
...
(assign,":var057",0),
(assign,":var058",0),
(try_for_range, ":p_059", "p_town_1", "p_salt_mine"),
    (try_begin),
...
(try_begin),
    ...
    (try_for_range, ":p_059", "p_town_1", "p_castle_1"),
        (try_begin),
            (party_slot_eq,":p_059",7,"trp_player"),
...
(try_begin),
    ...
    (try_for_range, ":p_059", "p_castle_1", "p_village_1"),
        (try_begin),
            (party_slot_eq,":p_059",7,"trp_player"),
...
(try_begin),
    ...
    (try_for_range, ":p_059", "p_village_1", "p_salt_mine"),
        (try_begin),
            (party_slot_eq,":p_059",7,"trp_player"),
...
(assign,":var006",0),
(assign,":var007",0),
(try_for_range, ":p_008", "p_town_1", "p_salt_mine"),
    (try_begin),
...
(try_for_range, ":p_008", "p_town_1", "p_salt_mine"),
    (try_begin),
        ...
        (try_begin),
            ...
            (assign,":var017",reg5),
            (assign,":var018",reg10),
            (store_sub, ":var019", ":p_008", "p_town_1"),
            (store_add, ":troop_id_020", ":var019", "trp_town_1_master_craftsman"),
        ...
        (try_begin),
            ...
            (store_sub, ":slot_no_028", ":party_slot_014", "itm_spice"),
        ...
        (try_begin),
            ...
            (store_sub, ":slot_no_028", ":item_slot_037", "itm_spice"),
            (val_add, ":slot_no_028", 250),
            (party_get_slot,":party_slot_029",":p_008",":slot_no_028"),
            (store_mul, ":var030", ":item_slot_021", 15),
            ...
            (try_begin),
                (gt,":var032",0),
                (store_sub, ":slot_no_028", ":item_slot_038", "itm_spice"),
                (val_add, ":slot_no_028", 250),
                (party_get_slot,":party_slot_029",":p_008",":slot_no_028"),
...
(overlay_set_position, reg0, 1),
(val_sub, ":var004", 25),
(store_sub, ":var005", ":var001", "itm_javelin_bow"),
(store_add, ":var005", ":var005", "str_javelin_bow"),
(try_begin),
...
(try_begin),
    ...
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_coop_assign_drop_companion_1", -1, "tableau_coop_companion_select_0", ":troop_id_008"),
...
(try_begin),
    ...
    (str_store_troop_name,s0,":troop_id_008"),
    (create_image_button_overlay_with_tableau_material, "$g_presentation_obj_coop_assign_drop_companion_2", -1, "tableau_coop_companion_select_0", ":troop_id_008"),
