...
(store_trigger_param, ":var001", 1),
(store_trigger_param, ":var002", 2),
(call_script, "check_creating_ladder_dust_effect",":var001",":var002"),
]),
...
(try_begin),
    (eq,":var009",1),
    (call_script, "coop_generate_item_drop", ":agent_player_id_003"), # ERROR 1
    (try_begin),
        (neq,":slot_no_010",-1),
...
(try_begin),
    ...
    (else_try),
        (call_script, "coop_drop_item", "$g_ccoop_currently_dropping_item",":var004",":var005"),
    (try_end),
(try_end),
