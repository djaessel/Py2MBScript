...
(try_begin),
    ...
    (str_store_string,s5,":prop_instance_get_scale(var001)"),
    (position_get_scale_x,":pos_scale_x_002",5),
    (store_time_of_day,reg12),
    (try_begin),
        (is_between,reg12,5,20),
        (store_mul, ":var003", 1000, ":pos_scale_x_002"),
        (store_mul, ":var004", 965, ":pos_scale_x_002"),
        (store_mul, ":var005", 900, ":pos_scale_x_002"),
    (else_try),
        (store_mul, ":var003", 450, ":pos_scale_x_002"),
        (store_mul, ":var004", 575, ":pos_scale_x_002"),
        (store_mul, ":var005", 750, ":pos_scale_x_002"),
    (try_end),
(try_end),
(val_div, ":var003", 100),
(val_div, ":var004", 100),
(val_div, ":var005", 100),
(set_current_color,":var003",":var003",":var003"),
...
(str_store_string,s5,":prop_instance_get_scale(var001)"),
(position_get_scale_x,":pos_scale_x_002",5),
(store_mul, ":var003", 600, ":pos_scale_x_002"),
(store_mul, ":var004", 435, ":pos_scale_x_002"),
(store_mul, ":var005", 135, ":pos_scale_x_002"),
(val_div, ":var003", 100),
(val_div, ":var004", 100),
(val_div, ":var005", 100),
(set_current_color,":var003",":var003",":var003"),
...
(str_store_string,s5,":prop_instance_get_scale(var001)"),
(position_get_scale_x,":pos_scale_x_002",5),
(store_mul, ":var003", 340, ":pos_scale_x_002"),
(store_mul, ":var004", 200, ":pos_scale_x_002"),
(store_mul, ":var005", 60, ":pos_scale_x_002"),
(val_div, ":var003", 100),
(val_div, ":var004", 100),
(val_div, ":var005", 100),
(set_current_color,":var003",":var003",":var003"),
...
(try_begin),
    ...
    (str_store_string,s5,":prop_instance_get_scale(var001)"),
    (position_get_scale_x,":pos_scale_x_002",5),
    (store_mul, ":var003", 480, ":pos_scale_x_002"),
    (store_mul, ":var004", 435, ":pos_scale_x_002"),
    (store_mul, ":var005", 300, ":pos_scale_x_002"),
    (val_div, ":var003", 100),
    (val_div, ":var004", 100),
    (val_div, ":var005", 100),
    (set_current_color,":var003",":var003",":var003"),
...
(try_begin),
    ...
    (prop_instance_get_position, pos1, ":var001"),
    ...
    (try_begin),
        (eq,":::g_round_ended",0),
        (scene_prop_get_team, ":team_no_002", ":var001"),
        (try_begin),
            (eq,":team_no_002",0),
            (assign,":var003",-1),
        (else_try),
        ...
        (try_begin),
            ...
            (store_mul, ":var004", ":var003", 1),
            (call_script, "script_show_multiplayer_message", 15, ":var004"),
    ...
    (assign,":var007",0),
    (get_max_players, ":max_players"),
    (try_for_range, ":player_id_006", 0, ":max_players"),
        (player_is_active, ":player_id_006"),
        (try_begin),
            (eq,"spr_catapult_destructible",":::g_destructible_target_1"),
            (player_get_slot,":player_slot_008",":player_id_006",32),
        (else_try),
            (player_get_slot,":player_slot_008",":player_id_006",33),
        (try_end),
        (val_add, ":var007", ":player_slot_008"),
    (try_end),
    (assign,":var009",0),
    (get_max_players, ":max_players"),
    (try_for_range, ":player_id_006", 0, ":max_players"),
    ...
    (try_begin),
        ...
        (assign,":var009",1500),
    (try_end),
    (val_mul, ":var009", ":::g_multiplayer_battle_earnings_multiplier"),
    (val_div, ":var009", 100),
    (get_max_players, ":max_players"),
    (try_for_range, ":player_id_006", 0, ":max_players"),
        (player_is_active, ":player_id_006"),
        ...
        (else_try),
            (player_get_slot,":player_slot_008",":player_id_006",33),
        (try_end),
        (player_get_gold, ":gold_010", ":player_id_006"),
        (val_mul, ":player_slot_008", ":var009"),
        (try_begin),
            (ge,":var007",":player_slot_008"),
            (gt,":player_slot_008",0),
            (store_div, ":var___x1", ":player_slot_008", ":var007"),
            (assign,":var011",":var___x1"),
        (else_try),
        (try_end),
        (val_add, ":gold_010", 0), # var011
...
(try_begin),
    (eq,1,1),
    (scene_prop_get_hit_points, ":scp_hit_points_003", ":var001"),
    (val_sub, ":scp_hit_points_003", ":var002"),
    (try_begin),
        (gt,":scp_hit_points_003",0),
...
(try_begin),
    ...
    (position_get_x,":pos_x_004",2),
    (try_begin),
        (ge,":pos_x_004",0),
        (agent_is_alive,":pos_x_004"),
        (agent_is_human,":pos_x_004"),
        (neg|agent_is_non_player, ":pos_x_004"),
        (agent_get_player_id,":agent_player_id_005",":pos_x_004"),
        (ge,":agent_player_id_005",0),
        (player_is_active, ":agent_player_id_005"),
        (try_begin),
            (eq,"spr_catapult_destructible",":::g_destructible_target_1"),
            (player_get_slot,":player_slot_006",":agent_player_id_005",32),
            (val_add, ":player_slot_006", ":var002"),
            (player_set_slot,":agent_player_id_005",32,":player_slot_006"),
        (else_try),
            (player_get_slot,":player_slot_006",":agent_player_id_005",33),
            (val_add, ":player_slot_006", ":var002"),
...
(store_trigger_param, ":var001", 1),
(store_trigger_param, ":var002", 2),
(call_script, "script_use_item", ":var002", ":var001"),
(get_max_players, ":max_players"),
...
(ti_on_scene_prop_destroy, [
(store_trigger_param, ":var002", 1),
(store_trigger_param, ":var003", 2),
(play_sound,"snd_dummy_destroyed"),
(assign,":var001",86),
(try_begin),
    (this_or_next|multiplayer_is_server),
    (neg|game_in_multiplayer_mode),
    (set_fixed_point_multiplier, 100),
    (prop_instance_get_position, pos1, ":var002"),
    (try_begin),
        (ge,":var003",0),
        (agent_get_position,pos2,":var003"),
        (try_begin),
    ...
    (position_get_distance_to_ground_level, ":distance_to_ground_level_004", 4),
    (val_sub, ":distance_to_ground_level_004", 100),
    (assign,":var005",":distance_to_ground_level_004"),
    (val_div, ":var005", 3),
    (try_begin),
        (ge,":var001",0),
        (val_add, ":var001", ":var005"),
    (else_try),
        (val_sub, ":var001", ":var005"),
    (try_end),
...
(ti_on_scene_prop_hit, [
(store_trigger_param, ":var001", 1),
(prop_instance_get_position, pos2, ":var001"),
(get_player_agent_no,":agent_no_002"),
(agent_get_position,pos3,":agent_no_002"),
(get_distance_between_positions,":distance_003",3,2),
(position_transform_position_to_local, 4,2,1),
(position_set_y,4,0),
(position_set_x,2,0),
(position_set_y,2,0),
(position_set_z,2,0),
(get_distance_between_positions,":distance_004",4,2),
(assign,":var005",43),
(val_sub, ":var005", ":distance_004"),
(val_mul, ":var005", 1299),
(val_div, ":var005", 4300),
(try_begin),
    (lt,":var005",0),
(try_end),
(val_div, ":distance_003", 91),
(assign,reg60,0), # var005
(assign,reg61,":distance_003"),
...
(val_div, ":pos_x_002", 100),
(get_player_agent_no,":agent_no_003"),
(try_begin),
    (eq,":agent_no_003",":pos_x_002"),
    (prop_instance_get_position, pos2, ":var001"),
    (agent_get_position,pos3,":agent_no_003"),
    (get_distance_between_positions,":distance_004",3,2),
    (position_transform_position_to_local, 4,2,1),
    (position_set_y,4,0),
    (position_set_x,2,0),
    (position_set_y,2,0),
    (position_set_z,2,0),
    (get_distance_between_positions,":distance_005",4,2),
    (assign,":var006",43),
    (val_sub, ":var006", ":distance_005"),
    (val_mul, ":var006", 1299),
    (val_div, ":var006", 4300),
    (try_begin),
        (lt,":var006",0),
        (assign,":var006",0),
    (try_end),
    (assign,"$g_last_archery_point_earned",":var006"),
    (val_div, ":distance_004", 91),
    (assign,reg60,":var006"),
    (assign,reg61,":distance_004"),
    (display_message, "str_archery_target_hit"),
    (try_begin),
        ...
        (prop_instance_get_variation_id_2, ":prop_variation_id_2__007", ":var001"),
        (val_sub, ":prop_variation_id_2__007", 1),
        (eq,":::g_tutorial_training_ground_current_score",":prop_variation_id_2__007"),
...
(ti_on_scene_prop_destroy, [
(store_trigger_param, ":var001", 1),
(prop_instance_get_starting_position, pos1, ":var001"),
(get_player_agent_no,":agent_no_002"),
(agent_get_position,pos2,":agent_no_002"),
(assign,":var003",80),
(try_begin),
    (position_is_behind_position,2,1),
    (val_mul, ":var003", -1),
...
(ti_on_scene_prop_use, [
(store_trigger_param, ":var001", 1),
(store_trigger_param, ":scene_prop_instance_id_002", 2),
(agent_get_position,pos1,":var001"),
(prop_instance_get_starting_position, pos2, ":scene_prop_instance_id_002"),
(scene_prop_get_slot,":scene_prop_slot_003",":scene_prop_instance_id_002",1),
(try_begin),
    (ge,":var001",0),
    (agent_get_team, ":agent_team_no_004", ":var001"),
    (try_begin),
        (this_or_next|eq,":agent_team_no_004",0),
        (eq,":scene_prop_slot_003",1),
        (eq,1,1),
        (call_script, "script_use_item", ":scene_prop_instance_id_002", ":var001"),
        (get_max_players, ":max_players"),
        (try_for_range, ":player_id_006", 1, ":max_players"),
            (player_is_active, ":player_id_006"),
...
(store_trigger_param, ":var001", 1),
(store_trigger_param, ":var002", 2),
(call_script, "script_check_creating_ladder_dust_effect", ":var001", ":var002"),
]),
...
("lamp_b", 0, "lamp_b", "0", [
(ti_on_scene_prop_init, [
(set_position_delta,65,65,65),
(particle_system_add_new,"psys_lamp_fire"),
(set_position_delta,70,70,70),
(particle_system_add_new,"psys_fire_glow_1"),
(particle_system_emit,"psys_fire_glow_1",9000000),
...
(try_begin),
    (eq,1,1),
    (set_fixed_point_multiplier, 1),
    (position_get_x,":pos_x_003",2),
    (get_player_agent_no,":agent_no_004"),
    (try_begin),
        (eq,":agent_no_004",":pos_x_003"),
        (assign,reg60,":var002"),
        (display_message, "str_delivered_damage"),
        (eq,":::g_tutorial_training_ground_horseman_trainer_state",6),
        (eq,":::g_tutorial_training_ground_horseman_trainer_completed_chapters",1),
        (prop_instance_get_variation_id_2, ":prop_variation_id_2__005", ":var001"),
        (val_sub, ":prop_variation_id_2__005", 1),
        (eq,":::g_tutorial_training_ground_current_score",":prop_variation_id_2__005"),
        (val_add, ":::g_tutorial_training_ground_current_score", 1),
    (try_end),
(try_end),
(play_sound,"snd_dummy_hit"),
...
(try_begin),
    (eq,1,1),
    (prop_instance_get_scene_prop_kind, ":scene_prop_kind_004", ":scene_prop_instance_id_002"),
    (assign,":var005",0),
    (try_begin),
        (neq,":scene_prop_kind_004","spr_viking_keep_destroy_sally_door_right"),
        (neq,":scene_prop_kind_004","spr_viking_keep_destroy_sally_door_left"),
        (neq,":scene_prop_kind_004","spr_earth_sally_gate_right"),
        (neq,":scene_prop_kind_004","spr_earth_sally_gate_left"),
        (position_is_behind_position,1,2),
        (assign,":var005",1),
    (else_try),
        (this_or_next|eq,":scene_prop_kind_004","spr_viking_keep_destroy_sally_door_right"),
        (this_or_next|eq,":scene_prop_kind_004","spr_viking_keep_destroy_sally_door_left"),
        (this_or_next|eq,":scene_prop_kind_004","spr_earth_sally_gate_right"),
        (eq,":scene_prop_kind_004","spr_earth_sally_gate_left"),
        (neg|position_is_behind_position,1,2),
    (try_end),
    (try_begin),
        (this_or_next|eq,1,1), # var005
        (eq,":scene_prop_slot_003",1),
        (eq,1,1),
        (call_script, "script_use_item", ":scene_prop_instance_id_002", ":var001"),
        (get_max_players, ":max_players"),
...
("multiplayer_coop_item_drop", spr_use_time(1)|sokf_type_player_limiter|sokf_moveable, "package", "bobaggage", [
(ti_on_scene_prop_use, [
]),

(ti_on_scene_prop_start_use, [
(store_trigger_param, ":cur_agent", 1),
(store_trigger_param, ":var002", 2),
(agent_get_player_id,":agent_player_id_003",":cur_agent"),
(try_begin),
    ...
    (try_for_agents, ":cur_agent"),
        ...
        (eq,":agent_group_007",":agent_player_id_003"),
        (agent_get_troop_id,":troop_id_008", ":cur_agent"),
        (this_or_next|player_slot_eq,":agent_player_id_003",43,":troop_id_008"),
        (player_slot_eq,":agent_player_id_003",44,":troop_id_008"),
        (try_begin),
            (eq,":var004",-1),
...
(try_end),
(assign,":var009",1),
(assign,":slot_no_010",-1),
(try_for_range, ":slot_no_011", 50, 60),
(eq,":var009",1),
(player_get_slot,":player_slot_012",":agent_player_id_003",":slot_no_011"),
(eq,":player_slot_012",":var002"),
(assign,":var009",0),
(try_end),
(try_end),
(try_for_range, ":slot_no_011", 50, 60),
(eq,":var009",1),
(player_get_slot,":player_slot_012",":agent_player_id_003",":slot_no_011"),
(eq,":player_slot_012",0),
(eq,":slot_no_010",-1),
(assign,":slot_no_010",":slot_no_011"),
(try_end),
(try_end),
(try_begin),
(eq,":var009",1),
(call_script, "script_coop_generate_item_drop", ":agent_player_id_003"),
(try_begin),
(neq,":slot_no_010",-1),
...
(eq,":var009",1),
(try_begin),
(neq,":agent_player_id_003",0),
(multiplayer_send_3_int_to_player, ":agent_player_id_003", 120, "$g_ccoop_currently_dropping_item", ":var004", ":var005"),
(else_try),
(call_script, "script_coop_drop_item", "$g_ccoop_currently_dropping_item", ":var004", ":var005"),
(try_end),
(try_end),
